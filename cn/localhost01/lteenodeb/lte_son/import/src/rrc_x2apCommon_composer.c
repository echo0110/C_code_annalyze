 ...
 *******************************************************************************
 *
 * $$Id: rrc_x2apCommon_composer.c $
 *
 *******************************************************************************
 *
 * File Description: File rrc_x2apCommon_composer.c added for SON module code
 *
 *******************************************************************************
 * Revision Details
 * ----------------
...
)
{
    ...
    SON_ASSERT(p_x2ap_enb_config_update_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_REQ", src_module_id, dest_module_id);

    msg_api_length = msg_length + CV_HDRSIZE + EXT_MSG_API_HDR_SIZE;
    ...
    if (p_msg == SON_PNULL)
    {
        SON_LOG(SON_OAM_LOG_ON, son_log_facility_name,  SON_ERROR,
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ENB_CONFIG_UPDATE_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ENB_CONFIG_UPDATE_REQ, msg_length, cell_index);

    /* Fill X2AP_ENB_CONFIG_UPDATE_REQ message */
    p_x2apCommon_msg = p_x2apCommon_msg + EXT_MSG_API_HDR_SIZE;
...
)
{
    ...
    SON_ASSERT(p_x2ap_plmn_identity != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_macro_enb_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_home_enb_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2_enb_id_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2_gb_enb_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_broadcast_plmn != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_earfcn != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_fdd_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_special_subframe_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_tdd_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_choice_eutra_mode != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_choice_eutra_mode_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_prach_configuration_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_subframe_allocation != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mbsfn_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mbsfn_subframe_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_served_cell_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_ecgi != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_nbour_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_nbour_cell_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_served_cell_info_arr != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_served_cells_to_add_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_served_cells_to_modify_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_served_cells_to_modify_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_served_cells_to_delete_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_gu_group_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_gu_group_id_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_neigh_ecgi_enb_id_map_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_neigh_ecgi_enb_id_map_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_enb_config_update_resp != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_RES", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ENB_CONFIG_UPDATE_RES, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ENB_CONFIG_UPDATE_RES, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_cause != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_enb_config_update_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ENB_CONFIG_UPDATE_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ENB_CONFIG_UPDATE_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_reset_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_RESET_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_RESET_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_RESET_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_reset_resp != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_RESET_RES", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_RESET_RES, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_RESET_RES, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_reset_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_RESET_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_RESET_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_RESET_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_add_enb_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ADD_ENB_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ADD_ENB_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ADD_ENB_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2_ip_addr != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2_ipv6_addr != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2_trans_layer_addrs != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2_extend_trans_layer_addrs != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2_enb_comm_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_add_enb_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ADD_ENB_RES", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ADD_ENB_RES, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ADD_ENB_RES, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_enb_comm_info_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_delete_enb_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_DEL_ENB_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_DEL_ENB_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_DEL_ENB_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_delete_enb_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_DEL_ENB_RES", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_DEL_ENB_RES, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_DEL_ENB_RES, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_enb_link_up_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ENB_LINK_UP_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ENB_LINK_UP_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ENB_LINK_UP_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_enb_link_down_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ENB_LINK_DOWN_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ENB_LINK_DOWN_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ENB_LINK_DOWN_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_enb_config_update_wait_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_WAIT_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ENB_CONFIG_UPDATE_WAIT_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_ENB_CONFIG_UPDATE_WAIT_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_ho_report_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_HO_REPORT_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_HO_REPORT_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_HO_REPORT_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_peer_cell_activation_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_PEER_CELL_ACTIVATION_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_PEER_CELL_ACTIVATION_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_PEER_CELL_ACTIVATION_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_cell_activation_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_peer_cell_activation_resp != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_PEER_CELL_ACTIVATION_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_PEER_CELL_ACTIVATION_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_PEER_CELL_ACTIVATION_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_cell_activation_resp != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_cell_activation_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_CELL_ACTIVATION_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_CELL_ACTIVATION_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_CELL_ACTIVATION_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_cell_activation_response != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_CELL_ACTIVATION_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_CELL_ACTIVATION_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_CELL_ACTIVATION_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mobility_change_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_CHANGE_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_MOBILITY_CHANGE_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_MOBILITY_CHANGE_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mob_param != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mobility_change_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mobility_change_resp != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_CHANGE_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_MOBILITY_CHANGE_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_MOBILITY_CHANGE_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mob_range != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mob_ch_resp != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mobility_setting_change_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_SETTING_CHANGE_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_MOBILITY_SETTING_CHANGE_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_MOBILITY_SETTING_CHANGE_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_x2ap_mobility_setting_change_resp != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_SETTING_CHANGE_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_MOBILITY_SETTING_CHANGE_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_x2apCommon_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, X2AP_MOBILITY_SETTING_CHANGE_RESP, msg_length, cell_index);
