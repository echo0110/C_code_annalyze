 ...
 *******************************************************************************
 *
 * $$Id: rrc_pack_unpack_utils.c $
 *
 *******************************************************************************
 *
 * File Description: File rrc_pack_unpack_utils.c added for SON module code
 *
 *******************************************************************************
 * Revision Details
 * ----------------
...
{
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((U8 *)p_src));
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((U16 *)p_src));
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %llu", varname, *((U64 *)p_src));
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((U32 *)p_src));
...
{
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((S8 *)p_src));
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((S16 *)p_src));
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((S32 *)p_src));
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((U8 *)p_dest));
...
)
{
    ...
    *(U16 *)p_dest  |= (U16)((U8*)p_src)[1];
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((U16 *)p_dest));
...
)
{
    ...
    *(U64 *)p_dest  |= (U64)((U8*)p_src)[7];
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %llu", varname, *((U64 *)p_dest));
...
)
{
    ...
    *(U32 *)p_dest  |= (U32)((U8*)p_src)[3];
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((U32 *)p_dest));
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((S8 *)p_dest));
...
)
{
    ...
    *(S16 *)p_dest  |= (S16)((U8*)p_src)[1];
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((S16 *)p_dest));
...
)
{
    ...
    *(S32 *)p_dest  |= (S32)((U8*)p_src)[3];
    ...
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "%s = %d", varname, *((S32 *)p_dest));
