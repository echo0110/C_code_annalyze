 ...
 *******************************************************************************
 *
 * $$Id: rrc_x2apCommon_parser.c $
 *
 *******************************************************************************
 *
 * File Description: File rrc_x2apCommon_parser.c added for SON module code
 *
 *******************************************************************************
 * Revision Details
 * ----------------
...
#include "rrc_pack_unpack_utils.h"
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_enb_config_update_req, 0, sizeof(x2ap_enb_config_update_req_t));

    /* This function parses x2ap_enb_config_update_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_enb_config_update_req");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_enb_config_update_req->num_peer_enb] should be in range [%d <= MAX_PEER_ENB] !", p_x2ap_enb_config_update_req->num_peer_enb);
        return RRC_FAILURE;
    }
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_plmn_identity, 0, sizeof(x2ap_plmn_identity_t));

    /* This function parses x2ap_plmn_identity */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_plmn_identity");
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_macro_enb_id, 0, sizeof(macro_enb_id_t));

    /* This function parses macro_enb_id */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing macro_enb_id");
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_home_enb_id, 0, sizeof(home_enb_id_t));

    /* This function parses home_enb_id */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing home_enb_id");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2_enb_id_info, 0, sizeof(x2_enb_id_info_t));

    /* This function parses x2_enb_id_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2_enb_id_info");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2_gb_enb_id, 0, sizeof(x2_gb_enb_id_t));

    /* This function parses x2_gb_enb_id */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2_gb_enb_id");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_broadcast_plmn, 0, sizeof(x2ap_broadcast_plmn_t));

    /* This function parses x2ap_broadcast_plmn */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_broadcast_plmn");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_broadcast_plmn->num_bcast_plmn_id] should be in range [1 <= %d <= MAX_NUM_BPLMN] !", p_x2ap_broadcast_plmn->num_bcast_plmn_id);
        return RRC_FAILURE;
    }
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_earfcn, 0, sizeof(x2ap_earfcn_t));

    /* This function parses x2ap_earfcn */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_earfcn");
    ...
    *p_length_read += sizeof(U32);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_earfcn->earfcn] should be in range [%d <= MAX_EARFCN] !", p_x2ap_earfcn->earfcn);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_fdd_info, 0, sizeof(x2ap_fdd_info_t));

    /* This function parses x2ap_fdd_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_fdd_info");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_fdd_info->ul_trnsmission_bdwidth] should be in range [%d <= 5] !", p_x2ap_fdd_info->ul_trnsmission_bdwidth);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_fdd_info->dl_trnsmission_bdwidth] should be in range [%d <= 5] !", p_x2ap_fdd_info->dl_trnsmission_bdwidth);
        return RRC_FAILURE;
    }
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_special_subframe_info, 0, sizeof(x2ap_special_subframe_info_t));

    /* This function parses x2ap_special_subframe_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_special_subframe_info");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_special_subframe_info->special_subframe_patterns] should be in range [%d <= 8] !", p_x2ap_special_subframe_info->special_subframe_patterns);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_special_subframe_info->dl_cp] should be in range [%d <= 1] !", p_x2ap_special_subframe_info->dl_cp);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_special_subframe_info->ul_cp] should be in range [%d <= 1] !", p_x2ap_special_subframe_info->ul_cp);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_tdd_info, 0, sizeof(x2ap_tdd_info_t));

    /* This function parses x2ap_tdd_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_tdd_info");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_tdd_info->trnsmission_bdwidth] should be in range [%d <= 5] !", p_x2ap_tdd_info->trnsmission_bdwidth);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_tdd_info->subframe_assn] should be in range [%d <= 6] !", p_x2ap_tdd_info->subframe_assn);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_choice_eutra_mode, 0, sizeof(x2ap_choice_eutra_mode_t));

    /* This function parses x2ap_choice_eutra_mode */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_choice_eutra_mode");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_choice_eutra_mode_info, 0, sizeof(x2ap_choice_eutra_mode_info_t));

    /* This function parses x2ap_choice_eutra_mode_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_choice_eutra_mode_info");
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_prach_configuration_info, 0, sizeof(x2ap_prach_configuration_info_t));

    /* This function parses x2ap_prach_configuration_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_prach_configuration_info");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_prach_configuration_info->root_sequence_index] should be in range [%d <= 837] !", p_x2ap_prach_configuration_info->root_sequence_index);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_prach_configuration_info->zero_correlation_zone_config] should be in range [%d <= 15] !", p_x2ap_prach_configuration_info->zero_correlation_zone_config);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_prach_configuration_info->high_speed_flag] should be in range [%d <= 1] !", p_x2ap_prach_configuration_info->high_speed_flag);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_prach_configuration_info->prach_frequency_offset] should be in range [%d <= 94] !", p_x2ap_prach_configuration_info->prach_frequency_offset);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_prach_configuration_info->prach_config_index] should be in range [%d <= 63] !", p_x2ap_prach_configuration_info->prach_config_index);
        return RRC_FAILURE;
    }
    }
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_subframe_allocation, 0, sizeof(x2ap_subframe_allocation_t));

    /* This function parses x2ap_subframe_allocation */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_subframe_allocation");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mbsfn_info, 0, sizeof(x2ap_mbsfn_info_t));

    /* This function parses x2ap_mbsfn_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mbsfn_info");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_mbsfn_info->radioframe_alloc_period] should be in range [%d <= 5] !", p_x2ap_mbsfn_info->radioframe_alloc_period);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_mbsfn_info->radioframe_alloc_offset] should be in range [%d <= 7] !", p_x2ap_mbsfn_info->radioframe_alloc_offset);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mbsfn_subframe_info, 0, sizeof(x2ap_mbsfn_subframe_info_t));

    /* This function parses x2ap_mbsfn_subframe_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mbsfn_subframe_info");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_mbsfn_subframe_info->num_mbsfn] should be in range [%d <= MAX_NUM_MBSFN] !", p_x2ap_mbsfn_subframe_info->num_mbsfn);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_served_cell_info, 0, sizeof(x2ap_served_cell_info_t));

    /* This function parses x2ap_served_cell_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_served_cell_info");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_served_cell_info->pci] should be in range [%d <= 503] !", p_x2ap_served_cell_info->pci);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_served_cell_info->num_antenna_port] should be in range [%d <= 2] !", p_x2ap_served_cell_info->num_antenna_port);
        return RRC_FAILURE;
    }
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_ecgi, 0, sizeof(x2ap_ecgi_t));

    /* This function parses x2ap_ecgi */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_ecgi");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_nbour_info, 0, sizeof(x2ap_nbour_info_t));

    /* This function parses x2ap_nbour_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_nbour_info");
    ...
    *p_length_read += sizeof(U32);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_nbour_info->pci] should be in range [%d <= 503] !", p_x2ap_nbour_info->pci);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_nbour_cell_info, 0, sizeof(x2ap_nbour_cell_info_t));

    /* This function parses x2ap_nbour_cell_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_nbour_cell_info");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_nbour_cell_info->num_neighbour_cell] should be in range [%d <= MAX_NEIGHBOURS] !", p_x2ap_nbour_cell_info->num_neighbour_cell);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_served_cell_info_arr, 0, sizeof(x2ap_served_cell_info_arr_t));

    /* This function parses x2ap_served_cell_info_arr */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_served_cell_info_arr");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_served_cells_to_add_list, 0, sizeof(x2ap_served_cells_to_add_list_t));

    /* This function parses x2ap_served_cells_to_add_list */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_served_cells_to_add_list");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_served_cells_to_add_list->num_served_cell] should be in range [1 <= %d <= MAX_SERVED_CELLS] !", p_x2ap_served_cells_to_add_list->num_served_cell);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_served_cells_to_modify_info, 0, sizeof(x2ap_served_cells_to_modify_info_t));

    /* This function parses x2ap_served_cells_to_modify_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_served_cells_to_modify_info");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_served_cells_to_modify_info->deactivation_ind] should be in range [%d <= 1] !", p_x2ap_served_cells_to_modify_info->deactivation_ind);
        return RRC_FAILURE;
    }
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_served_cells_to_modify_list, 0, sizeof(x2ap_served_cells_to_modify_list_t));

    /* This function parses x2ap_served_cells_to_modify_list */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_served_cells_to_modify_list");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_served_cells_to_modify_list->num_served_cell] should be in range [1 <= %d <= MAX_SERVED_CELLS] !", p_x2ap_served_cells_to_modify_list->num_served_cell);
        return RRC_FAILURE;
    }
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_served_cells_to_delete_list, 0, sizeof(x2ap_served_cells_to_delete_list_t));

    /* This function parses x2ap_served_cells_to_delete_list */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_served_cells_to_delete_list");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_served_cells_to_delete_list->num_served_cell] should be in range [1 <= %d <= MAX_SERVED_CELLS] !", p_x2ap_served_cells_to_delete_list->num_served_cell);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_gu_group_id, 0, sizeof(x2ap_gu_group_id_t));

    /* This function parses x2ap_gu_group_id */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_gu_group_id");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_gu_group_id_list, 0, sizeof(x2ap_gu_group_id_list_t));

    /* This function parses x2ap_gu_group_id_list */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_gu_group_id_list");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_gu_group_id_list->num_gu_group_id] should be in range [1 <= %d <= MAX_ENB_POOLS] !", p_x2ap_gu_group_id_list->num_gu_group_id);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_neigh_ecgi_enb_id_map_info, 0, sizeof(x2ap_neigh_ecgi_enb_id_map_info_t));

    /* This function parses x2ap_neigh_ecgi_enb_id_map_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_neigh_ecgi_enb_id_map_info");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_neigh_ecgi_enb_id_map_list, 0, sizeof(x2ap_neigh_ecgi_enb_id_map_list_t));

    /* This function parses x2ap_neigh_ecgi_enb_id_map_list */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_neigh_ecgi_enb_id_map_list");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_neigh_ecgi_enb_id_map_list->neigh_info_count] should be in range [1 <= %d <= MAX_NEIGHBOURS] !", p_x2ap_neigh_ecgi_enb_id_map_list->neigh_info_count);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_enb_config_update_resp, 0, sizeof(x2ap_enb_config_update_resp_t));

    /* This function parses x2ap_enb_config_update_resp */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_enb_config_update_resp");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_enb_config_update_resp->response] should be in range [%d <= 1] !", p_x2ap_enb_config_update_resp->response);
        return RRC_FAILURE;
    }
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_cause, 0, sizeof(x2ap_cause_t));

    /* This function parses x2ap_cause */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_cause");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_enb_config_update_ind, 0, sizeof(x2ap_enb_config_update_ind_t));

    /* This function parses x2ap_enb_config_update_ind */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_enb_config_update_ind");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_reset_req, 0, sizeof(x2ap_reset_req_t));

    /* This function parses x2ap_reset_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_reset_req");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_reset_resp, 0, sizeof(x2ap_reset_resp_t));

    /* This function parses x2ap_reset_resp */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_reset_resp");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_reset_resp->response] should be in range [%d <= 1] !", p_x2ap_reset_resp->response);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_reset_ind, 0, sizeof(x2ap_reset_ind_t));

    /* This function parses x2ap_reset_ind */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_reset_ind");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_add_enb_req, 0, sizeof(x2ap_add_enb_req_t));

    /* This function parses x2ap_add_enb_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_add_enb_req");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_add_enb_req->num_peer_enb] should be in range [1 <= %d <= MAX_PEER_ENB] !", p_x2ap_add_enb_req->num_peer_enb);
        return RRC_FAILURE;
    }
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2_ip_addr, 0, sizeof(x2_ip_addr_t));

    /* This function parses x2_ip_addr */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2_ip_addr");
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2_ipv6_addr, 0, sizeof(x2_ipv6_addr_t));

    /* This function parses x2_ipv6_addr */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2_ipv6_addr");
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2_trans_layer_addrs, 0, sizeof(x2_trans_layer_addrs_t));

    /* This function parses x2_trans_layer_addrs */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2_trans_layer_addrs");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2_trans_layer_addrs->data_length] should be in range [%d <= RRC_MAX_IP_ADDR_LEN_IPV6] !", p_x2_trans_layer_addrs->data_length);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2_extend_trans_layer_addrs, 0, sizeof(x2_extend_trans_layer_addrs_t));

    /* This function parses x2_extend_trans_layer_addrs */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2_extend_trans_layer_addrs");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2_extend_trans_layer_addrs->num_tlas] should be in range [1 <= %d <= MAX_NUM_ENB_X2AP_GTP_TLAS] !", p_x2_extend_trans_layer_addrs->num_tlas);
        return RRC_FAILURE;
    }
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2_enb_comm_info, 0, sizeof(x2_enb_comm_info_t));

    /* This function parses x2_enb_comm_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2_enb_comm_info");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2_enb_comm_info->num_ip_addr] should be in range [1 <= %d <= MAX_NUM_IP_ADDR] !", p_x2_enb_comm_info->num_ip_addr);
        return RRC_FAILURE;
    }
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2_enb_comm_info->num_ipv6_addr] should be in range [1 <= %d <= MAX_NUM_IP_ADDR] !", p_x2_enb_comm_info->num_ipv6_addr);
        return RRC_FAILURE;
    }
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2_enb_comm_info->num_tlas] should be in range [1 <= %d <= MAX_NUM_ENB_X2AP_EXT_TLAS] !", p_x2_enb_comm_info->num_tlas);
        return RRC_FAILURE;
    }
    }
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2_enb_comm_info->default_sgnb] should be in range [%d <= 1] !", p_x2_enb_comm_info->default_sgnb);
        return RRC_FAILURE;
    }
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_add_enb_res, 0, sizeof(x2ap_add_enb_res_t));

    /* This function parses x2ap_add_enb_res */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_add_enb_res");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_enb_comm_info_list, 0, sizeof(x2ap_enb_comm_info_list_t));

    /* This function parses x2ap_enb_comm_info_list */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_enb_comm_info_list");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_enb_comm_info_list->num_peer_enb] should be in range [1 <= %d <= MAX_PEER_ENB] !", p_x2ap_enb_comm_info_list->num_peer_enb);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_delete_enb_req, 0, sizeof(x2ap_delete_enb_req_t));

    /* This function parses x2ap_delete_enb_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_delete_enb_req");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_delete_enb_res, 0, sizeof(x2ap_delete_enb_res_t));

    /* This function parses x2ap_delete_enb_res */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_delete_enb_res");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_delete_enb_res->response] should be in range [%d <= 1] !", p_x2ap_delete_enb_res->response);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_enb_link_up_ind, 0, sizeof(x2ap_enb_link_up_ind_t));

    /* This function parses x2ap_enb_link_up_ind */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_enb_link_up_ind");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_enb_link_up_ind->num_served_cell] should be in range [1 <= %d <= MAX_SERVED_CELLS] !", p_x2ap_enb_link_up_ind->num_served_cell);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_enb_link_down_ind, 0, sizeof(x2ap_enb_link_down_ind_t));

    /* This function parses x2ap_enb_link_down_ind */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_enb_link_down_ind");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_enb_config_update_wait_ind, 0, sizeof(x2ap_enb_config_update_wait_ind_t));

    /* This function parses x2ap_enb_config_update_wait_ind */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_enb_config_update_wait_ind");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_enb_config_update_wait_ind->time_to_wait] should be in range [%d <= 2] !", p_x2ap_enb_config_update_wait_ind->time_to_wait);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_ho_report_ind, 0, sizeof(x2ap_ho_report_ind_t));

    /* This function parses x2ap_ho_report_ind */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_ho_report_ind");
    ...
    *p_length_read += sizeof(U32);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_ho_report_ind->ho_report_type] should be in range [%d <= 1] !", p_x2ap_ho_report_ind->ho_report_type);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_peer_cell_activation_req, 0, sizeof(x2ap_peer_cell_activation_req_t));

    /* This function parses x2ap_peer_cell_activation_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_peer_cell_activation_req");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_cell_activation_info, 0, sizeof(x2ap_cell_activation_info_t));

    /* This function parses x2ap_cell_activation_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_cell_activation_info");
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_cell_activation_info->num_served_cell] should be in range [1 <= %d <= MAX_SERVED_CELLS] !", p_x2ap_cell_activation_info->num_served_cell);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_peer_cell_activation_resp, 0, sizeof(x2ap_peer_cell_activation_resp_t));

    /* This function parses x2ap_peer_cell_activation_resp */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_peer_cell_activation_resp");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_cell_activation_resp, 0, sizeof(x2ap_cell_activation_resp_t));

    /* This function parses x2ap_cell_activation_resp */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_cell_activation_resp");
    ...
    *p_length_read += sizeof(U8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_cell_activation_resp->response] should be in range [%d <= 1] !", p_x2ap_cell_activation_resp->response);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(U16);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_cell_activation_resp->num_served_cell] should be in range [%d <= MAX_SERVED_CELLS] !", p_x2ap_cell_activation_resp->num_served_cell);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_cell_activation_req, 0, sizeof(x2ap_cell_activation_req_t));

    /* This function parses x2ap_cell_activation_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_cell_activation_req");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_cell_activation_response, 0, sizeof(x2ap_cell_activation_response_t));

    /* This function parses x2ap_cell_activation_response */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_cell_activation_response");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mobility_change_req, 0, sizeof(x2ap_mobility_change_req_t));

    /* This function parses x2ap_mobility_change_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mobility_change_req");
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mob_param, 0, sizeof(x2ap_mob_param_t));

    /* This function parses x2ap_mob_param */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mob_param");
    ...
    *p_length_read += sizeof(S8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_mob_param->handover_trigger_change] should be in range [-20 <= %d <= 20] !", p_x2ap_mob_param->handover_trigger_change);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mobility_change_info, 0, sizeof(x2ap_mobility_change_info_t));

    /* This function parses x2ap_mobility_change_info */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mobility_change_info");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mobility_change_resp, 0, sizeof(x2ap_mobility_change_resp_t));

    /* This function parses x2ap_mobility_change_resp */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mobility_change_resp");
...
)
{
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mob_range, 0, sizeof(x2ap_mob_range_t));

    /* This function parses x2ap_mob_range */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mob_range");
    ...
    *p_length_read += sizeof(S8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_mob_range->ho_trigger_change_lower_limit] should be in range [-20 <= %d <= 20] !", p_x2ap_mob_range->ho_trigger_change_lower_limit);
        return RRC_FAILURE;
    }
    ...
    *p_length_read += sizeof(S8);
    ...
    {
        SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_WARNING, "Parameter [p_x2ap_mob_range->ho_trigger_change_upper_limit] should be in range [-20 <= %d <= 20] !", p_x2ap_mob_range->ho_trigger_change_upper_limit);
        return RRC_FAILURE;
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mob_ch_resp, 0, sizeof(x2ap_mob_ch_resp_t));

    /* This function parses x2ap_mob_ch_resp */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mob_ch_resp");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mobility_setting_change_req, 0, sizeof(x2ap_mobility_setting_change_req_t));

    /* This function parses x2ap_mobility_setting_change_req */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mobility_setting_change_req");
...
)
{
    ...
    *p_length_read = 0;
    ...
    SON_MEMSET(p_x2ap_mobility_setting_change_resp, 0, sizeof(x2ap_mobility_setting_change_resp_t));

    /* This function parses x2ap_mobility_setting_change_resp */
    SON_LOG(SON_OAM_LOG_ON, SON_NULL,  SON_COMP_PARSE, "Parsing x2ap_mobility_setting_change_resp");
