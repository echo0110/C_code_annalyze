 ...
 *******************************************************************************
 *
 * File Description: File rrm_son_composer.c added for SON module code
 *
 *******************************************************************************
 * Revision Details
 * ----------------
...
)
{
    ...
    SON_ASSERT(p_rrm_son_register_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_REGISTER_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_REGISTER_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_REGISTER_REQ, msg_length, cell_index);

    /* Fill RRM_SON_REGISTER_REQ message */
    p_son_msg = p_son_msg + EXT_MSG_API_HDR_SIZE;
...
)
{
    ...
    SON_ASSERT(p_rrm_oam_cell_plmn_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_oam_eutran_global_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_cell_object_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_object_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_trgr_periodic_value != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_trgr_threshold_value != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_trgr_event_value != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_trigger != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_attribute != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_register_deregister_format != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_deregister_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_DEREGISTER_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_DEREGISTER_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_DEREGISTER_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_set_attribute_value_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_SET_ATTRIBUTE_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_SET_ATTRIBUTE_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_SET_ATTRIBUTE_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cell_switch_on_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_CELL_SWITCH_ON_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_CELL_SWITCH_ON_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_CELL_SWITCH_ON_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_non_registration_based_res != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cell_switch_off_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_CELL_SWITCH_OFF_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_CELL_SWITCH_OFF_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_CELL_SWITCH_OFF_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_registration_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_REGISTER_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_REGISTER_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_REGISTER_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_registration_based_res != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_deregistration_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_DEREGISTER_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_DEREGISTER_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_DEREGISTER_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_set_attr_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_SET_ATTRIBUTE_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_SET_ATTRIBUTE_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_SET_ATTRIBUTE_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_active_ue_cnt_report != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_NUM_ACTIVE_UE_REPORT", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_NUM_ACTIVE_UE_REPORT, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_NUM_ACTIVE_UE_REPORT, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_ue_count_threshold_hit_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_UE_COUNT_THRESHOLD_REACHED_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_UE_COUNT_THRESHOLD_REACHED_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_UE_COUNT_THRESHOLD_REACHED_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cell_switch_off_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_CELL_SWITCH_OFF_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_CELL_SWITCH_OFF_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_CELL_SWITCH_OFF_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cell_switch_on_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_CELL_SWITCH_ON_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_CELL_SWITCH_ON_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_CELL_SWITCH_ON_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cell_state_change_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_CELL_STATE_CHANGE_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_CELL_STATE_CHANGE_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_CELL_STATE_CHANGE_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_nmm_prepare_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_NMM_PREPARE_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_NMM_PREPARE_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_NMM_PREPARE_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_nmm_res != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_nmm_complete_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_NMM_COMPLETE_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_NMM_COMPLETE_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_NMM_COMPLETE_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_MEAS_CONFIG_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_MEAS_CONFIG_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_MEAS_CONFIG_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_speed_state_scale_factors != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_eutran != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_utran_pci_fdd_range != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_utran_fdd != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_utran_tdd != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_utran != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_geran_following_arfcns != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_geran_carrier_freqs != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_geran_physical_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_geran_carrier_freq_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_geran != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_carrier_freq_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_sys_time_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_pre_reg_hrpd_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_hrpd_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_csfb_reg_param_1XRTT != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_1xrtt_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_csfb_reg_param_1xrtt_r9 != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_ac_barring_config_1xrtt != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_cdma != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_inter_rat_meas_config != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_setup_meas_gap_config != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_gap_config != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_gap_config != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_MEAS_CONFIG_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_MEAS_CONFIG_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_MEAS_CONFIG_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_obj_remove_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_MEAS_CONFIG_OBJ_REMOVE_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_MEAS_CONFIG_OBJ_REMOVE_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_MEAS_CONFIG_OBJ_REMOVE_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_config_obj_remove_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_MEAS_CONFIG_OBJ_REMOVE_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_MEAS_CONFIG_OBJ_REMOVE_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_MEAS_CONFIG_OBJ_REMOVE_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_results_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_MEAS_RESULTS_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_MEAS_RESULTS_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_MEAS_RESULTS_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_eutran_neighbor_cell != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_eutran_meas_results != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_utran_physical_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_utran_geran_global_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_utran_neighbor_cell != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_utran_meas_results != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_geran_neighbor_cell != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_geran_meas_results != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_global_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_neighbor_cell != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cdma_meas_results != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_ho_report != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_HO_REPORT", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_HO_REPORT, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_HO_REPORT, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_utran_geran_global_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_others_global_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_inter_rat_global_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_oam_global_cell_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_offset_attr != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_eutran_strength != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_utran_strength != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_geran_strength != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_meas_strength != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_load_report_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_LOAD_REPORT_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_LOAD_REPORT_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_LOAD_REPORT_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_hw_load_ind != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_s1_tnl_load_ind != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_rrs_load_ind != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_comp_avl_cap != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_comp_avl_cap_grp != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_abs_status != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_cell_load_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_ho_attempt_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_HO_ATTEMPT_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_HO_ATTEMPT_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_HO_ATTEMPT_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_ho_failure_report != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_HO_FAILURE_REPORT", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_HO_FAILURE_REPORT, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_HO_FAILURE_REPORT, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_tnl_discovery_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_TNL_DISCOVERY_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_TNL_DISCOVERY_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_TNL_DISCOVERY_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_global_enb_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_tnl_discovery_res != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_TNL_DISCOVERY_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_TNL_DISCOVERY_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_TNL_DISCOVERY_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_enb_tnl_address != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_rach_config_req != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_RACH_CONFIG_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_RACH_CONFIG_REQ, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_RACH_CONFIG_REQ, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_rach_config_resp != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_RACH_CONFIG_RESP", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_RACH_CONFIG_RESP, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_RACH_CONFIG_RESP, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_rach_ue_info_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_RACH_UE_INFO_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_RACH_UE_INFO_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_RACH_UE_INFO_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_strong_cell_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_ue_prach_data_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_l2_rach_perf_report != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_L2_RACH_PERF_REPORT", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_L2_RACH_PERF_REPORT, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_L2_RACH_PERF_REPORT, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_enb_config_update_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_ENB_CONFIG_UPDATE_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_ENB_CONFIG_UPDATE_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_ENB_CONFIG_UPDATE_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_oam_gu_group_id != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_gu_group_id_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_eicic_enable_disable_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_EICIC_ENABLE_DISABLE_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_EICIC_ENABLE_DISABLE_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_EICIC_ENABLE_DISABLE_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_son_mbms_sf_info_ind != SON_PNULL);
...
)
{
    ...
    SON_LOG(SON_OAM_LOG_ON, son_log_facility_name, SON_INFO, "Src(%u)->Dst(%u):RRM_SON_MBMS_SF_INFO_IND", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    son_construct_cspl_header(p_son_msg, SON_VERSION_ID, src_module_id,
        dest_module_id, RRM_SON_MBMS_SF_INFO_IND, SON_NULL, msg_api_length);

    /* Fill interface header */
    p_son_msg = p_son_msg + CV_HDRSIZE;
    son_construct_interface_api_header(p_son_msg, transaction_id, (son_module_id_et)src_module_id,
        (son_module_id_et)dest_module_id, RRM_SON_MBMS_SF_INFO_IND, msg_length, cell_index);
...
)
{
    ...
    SON_ASSERT(p_rrm_subframe_allocation != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_mbsfn_config_info != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_mbsfn_subframe_config_list != SON_PNULL);
...
)
{
    ...
    SON_ASSERT(p_rrm_cell_sib2_mbsfn_data != SON_PNULL);
