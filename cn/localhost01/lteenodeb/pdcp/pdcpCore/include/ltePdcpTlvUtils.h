 ...
 ****************************************************************************
 *
 *  $Id: ltePdcpTlvUtils.h,v 1.1.1.1 2010/02/11 04:51:26 cm_intel Exp $
 *
 ****************************************************************************
 *
...
#define CONVERT_INT32_NETWORK_TO_HOST(data)
#define CONVERT_INT32_HOST_TO_NETWORK(data)
...
#define PDCP_NTOHS(data) ntohs_wrapper(data)
#define PDCP_HTONS(data) htons_wrapper(data)
#define PDCP_NTOHL(data) ntohl_wrapper(data)
#define PDCP_HTONL(data) htonl_wrapper(data)

#else /*MSG_BYTE_ORDER_MSB not defined*/
/*LSB (Intel) BYTE ORDER in messages between modules - default*/
#define PDCP_NTOHS(data) pdcpSwap16(ntohs_wrapper(data))
#define PDCP_HTONS(data) pdcpSwap16(htons_wrapper(data))
#define PDCP_NTOHL(data) pdcpSwap32(ntohl_wrapper(data))
#define PDCP_HTONL(data) pdcpSwap32(htonl_wrapper(data))
...
#define CONVERT_INT32_NETWORK_TO_HOST(data) { (data) = PDCP_NTOHL(data); }
#define CONVERT_INT32_HOST_TO_NETWORK(data) { (data) = PDCP_HTONL(data); }
