 ...
 */
Int rijndaelSetupEncrypt(rijndael_state *st, UInt8 *key, Int keybits)
{
  Int i = 0;
  UInt32 temp;
  UInt32 *rk=st->rk;
 ...
 * returns the number of rounds for the given cipher key size.
 */
Int rijndaelSetupDecrypt(rijndael_state *st, UInt8 *key, Int keybits)
{
  Int nrounds, i, j;
  UInt32 temp;
  UInt32 *rk=st->rk;
  ...
  nrounds = rijndaelSetupEncrypt(st, key, keybits);
...
void rijndaelEncrypt(rijndael_state *st, Int nrounds, UInt8 *plaintext, UInt8 *ciphertext)
{
...
void rijndaelDecrypt(rijndael_state *st, Int nrounds, UInt8 *ciphertext, UInt8 *plaintext)
{
  UInt32 s0, s1, s2, s3, t0, t1, t2, t3;
  UInt32 *rk=st->rk;
