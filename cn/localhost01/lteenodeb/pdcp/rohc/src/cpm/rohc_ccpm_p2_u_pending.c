 ...
 ******************************************************************************
 *
 *  $Id: rohc_ccpm_p2_u_pending.c,v 1.1.2.1 2010/11/03 09:08:45 gur22059 Exp $
 *
 ******************************************************************************
 *
 ...
 * Revision Details
 * ----------------
 * $Log: rohc_ccpm_p2_u_pending.c,v $
 * Revision 1.1.2.1  2010/11/03 09:08:45  gur22059
...
/*****************************************************************************
 * Function Name  : rohc_c_p2_u_irdyn_fo_pnd
 ...
 *****************************************************************************/
rohc_void_t rohc_c_p2_u_irdyn_fo_pnd ROHC_PARAMS((p_entity, p_csc),
                        rohc_entity_t *p_entity _AND_ rohc_csc_udp_t *p_csc)
{
	ROHC_ENTER_FN("rohc_c_p2_u_irdyn_fo_pnd");
    ...
    /* do nothing */
	ROHC_EXIT_FN("rohc_c_p2_u_irdyn_fo_pnd");
}

/*****************************************************************************
 * Function Name  : rohc_c_p2_u_uo_2_fo_pnd
 * Inputs         : p_entity - Pointer to rohc entity block
 *                  p_csc - Pointer to rohc compressor stream context block
 * Outputs        : None 
 * Returns        : None
 ...
 *                  transition state is PENDING for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_c_p2_u_uo_2_fo_pnd ROHC_PARAMS((p_entity, p_csc),
                        rohc_entity_t *p_entity _AND_ rohc_csc_udp_t *p_csc)
{
	ROHC_ENTER_FN("rohc_c_p2_u_uo_2_fo_pnd");
	/* allowed */
    /* +- SPR 17777 */
    LOG_PDCP_MSG( ROHC_CONTEXT_UNUSED, LOGDEBUG, PDCP_RRCOAM, pdcpCurrentTime_g,
            __LINE__,p_entity->rohc_entity_id.ueIndex,p_entity->rohc_entity_id.lcId,
	...
	ROHC_EXIT_FN("rohc_c_p2_u_uo_2_fo_pnd");
}

/*****************************************************************************
 * Function Name  : rohc_c_p2_u_ack_u_ir_pnd
 * Inputs         : p_entity - Pointer to rohc entity block
 *                  p_csc - Pointer to rohc compressor stream context block
 * Outputs        : None 
 * Returns        : None
 ...
 *                  transition state is PENDING for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_c_p2_u_ack_u_ir_pnd ROHC_PARAMS((p_entity, p_csc),
                        rohc_entity_t *p_entity _AND_ rohc_csc_udp_t *p_csc)
{
	ROHC_ENTER_FN("rohc_c_p2_u_ack_u_ir_pnd");
	...
	ROHC_EXIT_FN("rohc_c_p2_u_ack_u_ir_pnd");
}
