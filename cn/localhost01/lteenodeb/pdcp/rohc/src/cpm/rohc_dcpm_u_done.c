 ...
 ******************************************************************************
 *
 *  $Id: rohc_dcpm_u_done.c,v 1.1.1.1 2010/02/11 04:51:26 cm_intel Exp $
 *
 ******************************************************************************
 *
...
/*****************************************************************************
 * Function Name  : rohc_d_u_ir_nc_dn
 ...
 *****************************************************************************/
rohc_void_t rohc_d_u_ir_nc_dn ROHC_PARAMS((p_entity, p_dsc), rohc_entity_t
                                             *p_entity _AND_ rohc_dsc_t *p_dsc)
{
	ROHC_ENTER_FN("rohc_d_u_ir_nc_dn");
    ...
    /* +- SPR 17777 */
	ROHC_EXIT_FN("rohc_d_u_ir_nc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_u_ir_irdyn_uor2_sc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  profiles.
 *****************************************************************************/
rohc_void_t rohc_d_u_ir_irdyn_uor2_sc_dn ROHC_PARAMS((p_entity, p_dsc), rohc_entity_t
                                             *p_entity _AND_ rohc_dsc_t *p_dsc)
{
	ROHC_ENTER_FN("rohc_d_u_ir_irdyn_uor2_sc_dn");
	...
	ROHC_EXIT_FN("rohc_d_u_ir_irdyn_uor2_sc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_u_all_fc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  profiles.
 *****************************************************************************/
rohc_void_t rohc_d_u_all_fc_dn ROHC_PARAMS((p_entity, p_dsc), rohc_entity_t
                                             *p_entity _AND_ rohc_dsc_t *p_dsc)
{
	ROHC_ENTER_FN("rohc_d_u_all_fc_dn");
	if( !(p_dsc->decom_res))
	{
		p_dsc->k_1++;	
    ...
    LOG_PDCP_MSG( ROHC_CONTEXT_UNUSED, LOGDEBUG, PDCP_RRCOAM, pdcpCurrentTime_g,
            ...
            ROHC_GET_DSC_CID(p_dsc),0,0,0, __func__,"");
    /* +- SPR 17777 */
	ROHC_EXIT_FN("rohc_d_u_all_fc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_u_ack_u_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_u_ack_u_dn ROHC_PARAMS((p_entity, p_dsc), rohc_entity_t
                                             *p_entity _AND_ rohc_dsc_t *p_dsc)
{
	ROHC_ENTER_FN("rohc_d_u_ack_u_dn");
    /* +- SPR 17777 */
    LOG_PDCP_MSG( ROHC_CONTEXT_UNUSED, LOGDEBUG, PDCP_RRCOAM, pdcpCurrentTime_g,
            __LINE__,p_entity->rohc_entity_id.ueIndex,p_entity->rohc_entity_id.lcId,
            ROHC_GET_DSC_CID(p_dsc),0,0,0, __func__,"");
	...
	ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
		                          ...
		                          p_entity->rohc_entity_id.ueIndex,p_entity->rohc_entity_id.lcId,
		                          ROHC_GET_DSC_CID(p_dsc));	
	ROHC_EXIT_FN("rohc_d_u_ack_u_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_u_mt_u_to_o_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *****************************************************************************/
rohc_void_t rohc_d_u_mt_u_to_o_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ rohc_dsc_t *p_dsc)
{
	ROHC_ENTER_FN("rohc_d_u_mt_u_to_o_dn");
	...
	ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
		                          ...
		                          p_entity->rohc_entity_id.ueIndex,p_entity->rohc_entity_id.lcId,
		                          ROHC_GET_DSC_CID(p_dsc));
	ROHC_EXIT_FN("rohc_d_u_mt_u_to_o_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_u_mt_u_to_r_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *****************************************************************************/
rohc_void_t rohc_d_u_mt_u_to_r_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ rohc_dsc_t *p_dsc)
{
	ROHC_ENTER_FN("rohc_d_u_mt_u_to_r_dn");
	...
	ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
		                          ...
		                          p_entity->rohc_entity_id.ueIndex,p_entity->rohc_entity_id.lcId,
		                          ROHC_GET_DSC_CID(p_dsc));
	ROHC_EXIT_FN("rohc_d_u_mt_u_to_r_dn");
}
