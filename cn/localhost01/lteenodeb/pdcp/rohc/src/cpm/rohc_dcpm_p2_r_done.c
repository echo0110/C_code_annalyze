 ...
 ******************************************************************************
 *
 *  $Id: rohc_dcpm_p2_r_done.c,v 1.1.2.1 2010/11/03 09:11:40 gur22059 Exp $
 *
 ******************************************************************************
 *
 ...
 * Revision Details
 * ----------------
 * $Log: rohc_dcpm_p2_r_done.c,v $
 * Revision 1.1.2.1  2010/11/03 09:11:40  gur22059
...
/*****************************************************************************
 * Function Name  : rohc_d_p2_r_ir_nc_dn
 ...
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_ir_nc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                              rohc_entity_t *p_entity _AND_ 
                                              rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_ir_nc_dn");
    if(p_dsc->decom_res)
    {
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_ir_nc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_ir_sc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_ir_sc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                              rohc_entity_t *p_entity _AND_ 
                                              rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_ir_sc_dn");
    if(p_dsc->decom_res)
    {
        p_dsc->d_state = ROHC_D_ST_FC;
        ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_ir_sc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_ir_fc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_ir_fc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                              rohc_entity_t *p_entity _AND_ 
                                              rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_ir_fc_dn");
    if(p_dsc->decom_res)
    {
        ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_ir_fc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_irdyn_nc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_irdyn_nc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                                 rohc_entity_t *p_entity _AND_ 
                                                 rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_irdyn_nc_dn");
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  ...
                                  ROHC_GET_DSC_CID(p_dsc));    
    rohc_dcpm_p2_send_static_nack(p_entity, p_dsc, ROHC_TRUE);
    ROHC_EXIT_FN("rohc_d_p2_r_irdyn_nc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_irdyn_sc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_irdyn_sc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                                 rohc_entity_t *p_entity _AND_ 
                                                 rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_irdyn_sc_dn");
    rohc_d_p2_r_ir_sc_dn(p_entity, p_dsc);
    ROHC_EXIT_FN("rohc_d_p2_r_irdyn_sc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_irdyn_fc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_irdyn_fc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                                 rohc_entity_t *p_entity _AND_ 
                                                 rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_irdyn_fc_dn");
    rohc_d_p2_r_ir_fc_dn(p_entity, p_dsc);
    ROHC_EXIT_FN("rohc_d_p2_r_irdyn_fc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_0_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_0_dn ROHC_PARAMS((p_entity, p_dsc), 
                                            rohc_entity_t *p_entity _AND_ 
                                            rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_0_dn");
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_r_0_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_0_crc_nc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_0_crc_nc_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ 
                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_0_crc_nc_dn");
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_r_0_crc_nc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_0_crc_sc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_0_crc_sc_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ 
                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_0_crc_sc_dn");
   /* rohc_dcpm_send_static_nack(p_entity, p_dsc, ROHC_TRUE);
   */
   /* as ROHC-3095 not saying on this */
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  ...
                                  ROHC_GET_DSC_CID(p_dsc));
    rohc_dcpm_p2_send_nack(p_entity, p_dsc, ROHC_TRUE);
   ROHC_EXIT_FN("rohc_d_p2_r_r_0_crc_sc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_0_crc_fc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_0_crc_fc_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ 
                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_0_crc_fc_dn");
    /* udpate the context PRM */
    /* send ack for first r_O_crc of a seq. this pkt*/
    rohc_d_p2_r_ir_fc_dn(p_entity, p_dsc);
    ROHC_EXIT_FN("rohc_d_p2_r_r_0_crc_fc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_1_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_1_dn ROHC_PARAMS((p_entity, p_dsc), 
                                            rohc_entity_t *p_entity _AND_ 
                                            rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_1_dn");
    /*rohc_dcpm_send_static_nack(p_entity, p_dsc, ROHC_TRUE); */
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  ...
                                  p_entity->rohc_entity_id.lcId,
                                  ROHC_GET_DSC_CID(p_dsc));
    ROHC_EXIT_FN("rohc_d_p2_r_r_1_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_2_nc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_2_nc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                               rohc_entity_t *p_entity _AND_ 
                                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_2_nc_dn");
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  ...
                                  ROHC_GET_DSC_CID(p_dsc));
    rohc_dcpm_p2_send_static_nack(p_entity, p_dsc, ROHC_TRUE);
    ROHC_EXIT_FN("rohc_d_p2_r_r_2_nc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_2_sc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_2_sc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                               rohc_entity_t *p_entity _AND_ 
                                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_2_sc_dn");

    rohc_d_p2_r_ir_sc_dn(p_entity, p_dsc);
    ROHC_EXIT_FN("rohc_d_p2_r_r_2_sc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_r_2_fc_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_r_2_fc_dn ROHC_PARAMS((p_entity, p_dsc), 
                                               rohc_entity_t *p_entity _AND_ 
                                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_r_2_fc_dn");

    rohc_d_p2_r_ir_fc_dn(p_entity, p_dsc);
    ROHC_EXIT_FN("rohc_d_p2_r_r_2_fc_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_ack_r_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_ack_r_dn ROHC_PARAMS((p_entity, p_dsc), 
                                              rohc_entity_t *p_entity _AND_ 
                                              rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_ack_r_dn");
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  "ACK_R handling, but "
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_ack_r_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_static_nack_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_static_nack_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ 
                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_static_nack_dn");
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_static_nack_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_nack_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_nack_dn ROHC_PARAMS((p_entity, p_dsc), 
                                             rohc_entity_t *p_entity _AND_ 
                                             rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_nack_dn");
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  "NACK_R handling, but "
                                  " nothing needs to be done in DCPM\n",
                                  p_entity->rohc_entity_id.ueIndex,
    ...
    ROHC_EXIT_FN("rohc_d_p2_r_nack_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_mt_r_to_u_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_mt_r_to_u_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ 
                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_mt_r_to_u_dn");
    ...
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  ...
                                  p_entity->rohc_entity_id.lcId,
                                  ROHC_GET_DSC_CID(p_dsc));
    ROHC_EXIT_FN("rohc_d_p2_r_mt_r_to_u_dn");
}

/*****************************************************************************
 * Function Name  : rohc_d_p2_r_mt_r_to_o_dn
 * Inputs         : p_entity - Pointer to rohc entity(global context block)
 *                  p_dsc - Pointer to rohc decompressor stream context block
 * Outputs        : None
 * Returns        : None
 ...
 *                  transition state is DONE for compressed profiles.
 *****************************************************************************/
rohc_void_t rohc_d_p2_r_mt_r_to_o_dn ROHC_PARAMS((p_entity, p_dsc),
                               rohc_entity_t *p_entity _AND_ 
                               rohc_dsc_udp_t *p_dsc)
{
    ROHC_ENTER_FN("rohc_d_p2_r_mt_r_to_o_dn");
    p_dsc->d_trans_state = ROHC_D_TST_INITIATED;
    ...
    ROHC_LOG(LOG_INFO,"DCPM:EID[%u:%u]:CID[%u]:"
                                  ...
                                  p_entity->rohc_entity_id.lcId,
                                  ROHC_GET_DSC_CID(p_dsc));
    ROHC_EXIT_FN("rohc_d_p2_r_mt_r_to_o_dn");
}
