...
{
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((U8 *)p_src));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((U16 *)p_src));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %llu", varname, *((U64 *)p_src));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((U32 *)p_src));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
{
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((S8 *)p_src));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((S16 *)p_src));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((S32 *)p_src));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((U8 *)p_dest));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((U16 *)p_dest));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %llu", varname, *((U64 *)p_dest));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((U32 *)p_dest));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((S8 *)p_dest));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((S16 *)p_dest));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
...
#ifdef RRM_DEBUG
    RRM_TRACE(RRM_TRUE, RRM_PNULL, RRM_COMP_PARSE, "%s = %d", varname, *((S32 *)p_dest));
#endif
    /* SPR 18044 Fix +- */
    (void)varname;
    return(RRM_SUCCESS);
