...
*       Contains the rule for generation of pup-tool code. We are maintaining 2 copies
*       of this file. First one this file itself another one rrm_oam_types_mirror.h.
*       Main reason to do this RRM_OAM_CELL_CONFIG_REQ and RRM_OAM_CELL_RECONFIG_REQ
*       using the same structure to generate the composer and parser for cell config
*       and cell reconfig optional parameters are different. In this file we kept the 
*       rrm_oam_cell_config_req_t structure for cell reconfig generation.
*       
*
...
*   29 Sep 2014    gur37691     eICIC STG 1     Structures added for eICIC feature.
*   14 Nov 2014    gur34951     eICIC STG 1     Added IE for rrm_oam_eicic_info_t structure
*
...
/* SPR 20653 Fix Start */
#define RRM_OAM_SRS_DURATION_PRESENT        0x02
#define RRM_OAM_SRS_HOPPING_ENABLE_PRESENT  0x04
#define RRM_OAM_SRS_PERIODICITY_PRESENT     0x08
/* SPR 20653 Fix End */
/*! \  rrm_oam_srs_t
...
typedef struct _rrm_oam_srs
{
    ...
    /* SPR 20653 Fix Start */
    rrm_bool_t              srs_hopping_enable;  /*^ O, RRM_OAM_SRS_HOPPING_ENABLE_PRESENT, H, 0, 1 ^*/
    U8                      srs_duration;         /*^ O, RRM_OAM_SRS_DURATION_PRESENT, H, 0, 1 ^*/
    U8                      srs_periodicity;      /*^ O, RRM_OAM_SRS_PERIODICITY_PRESENT, H, 0, 7 ^*/
    /* SPR 20653 Fix End */
}rrm_oam_srs_t;
/*! \  rrm_oam_prach_t
...
typedef struct __lower_layer_comm_info_t
{
    /*SPR 22325 +-*/
    rrm_bitmask_t	bitmask;                     /*^ BITMASK ^*/
...
{
     rrm_bitmask_t                              bitmask; /*^ BITMASK ^*/
     rrm_oam_common_params_t    		idle_mode_mobility_common_params;/*^ O, RRM_OAM_IDLE_MODE_MOBILITY_COMMON_PARAMS_PRESENT, N, 0, 0 ^*/
     rrm_oam_intra_freq_params_t        	idle_mode_mobility_intra_freq_params;/*^ O, RRM_OAM_IDLE_MODE_MOBILITY_INTRA_FREQ_PRESENT, N, 0, 0 ^*/
     rrm_oam_inter_frequency_params_list_t 	idle_mode_inter_freq_params_list; /*^ O,  RRM_OAM_IDLE_MODE_MOBILITY_INTER_FREQ_PRESENT, N, 0, 0 ^*/
...
/* Fix for CSR: 00059124 */
/* SPR 20653 Fix Start */
#define RRM_OAM_MAC_ECID_MEAS_START_SFN_PRESENT   0x100
/* SPR 20653 Fix End */
/* SPR 21958 PUSCH RAT1 Support Start */
#define RRM_OAM_UPLINK_RAT1_SUPPORT_INFO_PRESENT  0x200
/* SPR 21958 PUSCH RAT1 Support End */
/*eMTC Changes start*/
#define RRM_OAM_MAC_LAYER_PARAM_RACH_BR_PRESENT   0x400
/*eMTC Changes stop*/
...
typedef struct _rrm_oam_mac_layer_params
{
        ...
        rrm_oam_dci_format_for_si_msgs_et    dci_format_for_si_msg; /*^ O, RRM_OAM_DCI_FORMAT_FOR_SI_MSG_PRESENT, H, 0, 1 ^*/
        /* + SPR 17665 + */
        U8                              num_rbs_per_tbs_dci_1a[RBS_FOR_DCI_1A_SIZE]; /*^ O, RRM_OAM_NUM_OF_RB_DCI_FORMAT_1A_PRESENT, OCTET_STRING, FIXED ^*/
        U8                              num_rbs_per_tbs_dci_1c[RBS_FOR_DCI_1C_SIZE]; /*^ O, RRM_OAM_NUM_OF_RB_DCI_FORMAT_1C_PRESENT, OCTET_STRING, FIXED ^*/
        /* - SPR 17665 - */
        ...
        /* SPR 19310 - */
        /* SPR 20653 Fix Start */
        U8                  mac_ecid_meas_start_sfn;  /*^ O, RRM_OAM_MAC_ECID_MEAS_START_SFN_PRESENT, H, 0, 255 ^*/
        /* SPR 20653 Fix End */
	/* SPR 21958 PUSCH RAT1 Support Start */
...
{	
	/*CID 97163 Start*/
        U16                 count;  /*^ M, 0, H, 0, RRM_OAM_RF_CONFIGURATION_DL_EARFCN_MAX_COUNT^*/  
/* SPR-18445 stop */
	/*CID 97163 End*/
        U32                 earfcnDl[RRM_OAM_RF_CONFIGURATION_DL_EARFCN_MAX_COUNT];/*^ M, 0, OCTET_STRING, VARIABLE ^*/
}rrm_oam_earfcn_dl_t;
...
{
        U16                 count;  /*^ M, 0, B, 1, RRM_OAM_RF_CONFIGURATION_FREQ_BAND_IND_COUNT^*/    
/* SPR-18445 stop */
        U8                  freqBandInd[RRM_OAM_RF_CONFIGURATION_FREQ_BAND_IND_COUNT];/*^ M, 0, OCTET_STRING, VARIABLE ^*/
...
/* SPR 20653 Fix Start */
#define RRM_OAM_RB_SIZE_PRESENT                 0x20
#define RRM_OAM_ANTENNA_PORTS_COUNT_NO_PRESENT   0x40
/* SPR 20653 Fix End */
 ...
 *  \param freq_band_ind_list represnts list of frequency band when LAA is Eligible
 */
typedef struct _rrm_oam_rf_configurations
{
    ...
    /* SPR 20653 Fix Start */
    U8              rb_size;              /*^ O, RRM_OAM_RB_SIZE_PRESENT, H, 0, 1^*/
    U8		        antenna_ports_count_number; /*^ O, RRM_OAM_ANTENNA_PORTS_COUNT_NO_PRESENT, B, 1, 4^*/
    /* SPR 20653 Fix End */
...
typedef struct _rrm_oam_intra_freq_cells
{
	...
	U8                                csg_identity[RRM_OAM_MAX_NUM_CSG_OCTETS];  /*^ O, RRM_OAM_INTRA_FREQ_CSG_ID_PRESENT, OCTET_STRING, FIXED ^*/
        ...
        /* eICIC_PHASE_1_2_CHANGES_START */
        rrm_oam_intf_scheme_type_et       interference_scheme; /* O, RRM_OAM_INTRA_FREQ_INTF_SCHEME__PRESENT,B,0,2 ^*/
        /* eICIC_PHASE_1_2_CHANGES_END */
}rrm_oam_intra_freq_cells_t;
...
{
  rrm_bitmask_t   bitmask; /*^ BITMASK ^*/
  U8              rohc_profile0x0001; /*^ O, RRM_OAM_ROHC_PROFILE_1_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0002; /*^ O, RRM_OAM_ROHC_PROFILE_2_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0003; /*^ O, RRM_OAM_ROHC_PROFILE_3_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0004; /*^ O, RRM_OAM_ROHC_PROFILE_4_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0006; /*^ O, RRM_OAM_ROHC_PROFILE_6_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0101; /*^ O, RRM_OAM_ROHC_PROFILE_101_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0102; /*^ O, RRM_OAM_ROHC_PROFILE_102_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0103; /*^ O, RRM_OAM_ROHC_PROFILE_103_PRESENT, H, 0, 1^*/
  U8              rohc_profile0x0104; /*^ O, RRM_OAM_ROHC_PROFILE_104_PRESENT, H, 0, 1^*/
}rrm_oam_rohc_profiles_t;
...
{
  rrm_bitmask_t            bitmask;  /*^ BITMASK ^*/
  U8                       enable_rohc; /*^ O, RRM_OAM_ROHC_ENABLE_PRESENT, H, 0, 1^*/
...
#define RRM_OAM_RLC_UM_PDCP_SN_SIZE_PRESENT     0x0004
...
typedef struct _rrm_oam_sn_field_len_t 
{
  ...
  U8                rlc_um_pdcp_sn_size; /*^O, RRM_OAM_RLC_UM_PDCP_SN_SIZE_PRESENT, N, 0, 0^*/
}rrm_oam_sn_field_len_t;

#define RRM_OAM_TMR_POLL_PDU_PRESENT            0x01
#define RRM_OAM_TMR_REORDER_FOR_AM_MODE_PRESENT 0x02
#define RRM_OAM_TMR_REORDER_FOR_UM_MODE_PRESENT 0x04
#define RRM_OAM_TMR_RETRSMIT_PRESENT            0x08
#define RRM_OAM_TMR_STATUS_PROHIBIT_PRESENT     0x10
...
typedef struct _rrm_oam_addl_rlc_params_t
{
  ...
  rrm_oam_t_reordering_et		t_reordering_um;/*^ O, RRM_OAM_TMR_REORDER_FOR_UM_MODE_PRESENT, H, 0, 30 ^*/
  ...
  /* eMTC changes stop */
  rrm_oam_t_status_prohibit_et	t_status_prohibit;/*^ O, RRM_OAM_TMR_STATUS_PROHIBIT_PRESENT, H, 0, 55 ^*/
...
/* CSR-82507[SPR-12487]-fix start */
/* Code Deleted */
/* CSR-82507[SPR-12487]-fix end */
#define RRM_OAM_MAX_RLC_TRANS_PRESENT           0x000100
#define RRM_OAM_PDCP_ROHC_PARAMS_PRESENT        0x000200
#define RRM_OAM_PDCP_DISCARD_TIMER_PRESENT      0x000400
...
#define RRM_OAM_LOGICAL_CHANNEL_GROUP_PRESENT   0x100000
#define RRM_OAM_RLC_AM_STATUS_REPORT_PRESENT    0x200000
#define RRM_OAM_RLC_AM_ENB_STATUS_REPORT_PRESENT    0x400000
...
/* SPR 20653 Fix Start */
#define RRM_OAM_BUCKET_SIZE_DURATION_PRESENT        0x4000000
#define RRM_OAM_PRIORITIZED_BIT_RATE_PRESENT        0x8000000
/* SPR 20653 Fix End */
#define RRM_OAM_LWA_BEARER_REQUIRED                 0x10000000
...
typedef struct _rrm_oam_qos_config_params
{
    ...
    rrm_oam_pdcp_discard_timer_et     pdcp_discard_timer; /*^ O, RRM_OAM_PDCP_DISCARD_TIMER_PRESENT , H, 0, 7^*/
    ...
    U8                                logical_channel_group;  /*^ O, RRM_OAM_LOGICAL_CHANNEL_GROUP_PRESENT, H, 0, 3 ^*/
    rrm_bool_et                       rlc_am_status_report_required; /*^ O, RRM_OAM_RLC_AM_STATUS_REPORT_PRESENT, H, 0, 1 ^*/
    rrm_bool_et                       rlc_am_enb_status_report_required; /*^ O, RRM_OAM_RLC_AM_ENB_STATUS_REPORT_PRESENT, H, 0, 1 ^*/
    ...
    /*SRVCC SUPPORT END*/
    /* SPR 20653 Fix Start */
    rrm_oam_bucket_size_duration_et   bucket_size_duration; /*^O, RRM_OAM_BUCKET_SIZE_DURATION_PRESENT, N, 0, 0^*/
    rrm_oam_prioritized_bit_rate_et   prioritized_bit_rate; /*^O, RRM_OAM_PRIORITIZED_BIT_RATE_PRESENT, N, 0, 0^*/
    /* SPR 20653 Fix End */
...
typedef struct _rrm_oam_general_epc_params
{
	rrm_bitmask_t 			bitmask; /*^ BITMASK ^*/ 
/* SPR-18445 start */
	U8 				num_valid_plmn; /*^M, 0, B, 1, RRM_OAM_MAX_NUM_PLMNS ^*/ 
/* SPR-18445 stop */
...
#define RRM_OAM_OLPC_PUSCH_SUPPORTED_TABLE_PRESENT      0x01
typedef struct _rrm_oam_olpc_pusch_config_params_t
{
    rrm_bitmask_t       bitmask;                   /*^ BITMASK ^*/
/* SPR 20653_1 Fix Start */
    rrm_olpc_supported_table_t      olpc_pusch_supported_table[RRM_OLPC_CATEGORY_TABLE_SIZE]; /*^ O, RRM_OAM_OLPC_PUSCH_SUPPORTED_TABLE_PRESENT, OCTET_STRING, FIXED ^*/
/* SPR 20653_1 Fix End */
...
#define RRM_OAM_OLPC_PUCCH_SUPPORTED_TABLE_PRESENT      0x01
#define RRM_OAM_OLPC_PUCCH_SNR_THRESHOLD_PRESENT        0x02
typedef struct _rrm_oam_olpc_pucch_config_params_t
{
    rrm_bitmask_t       bitmask;                   /*^ BITMASK ^*/
/* SPR 20653_1 Fix Start */
    rrm_olpc_supported_table_t     olpc_pucch_supported_table[RRM_OLPC_CATEGORY_TABLE_SIZE]; /*^ O, RRM_OAM_OLPC_PUCCH_SUPPORTED_TABLE_PRESENT, OCTET_STRING, FIXED ^*/
/* SPR 20653_1 Fix End */
    U8                  olpc_pucch_snr_threshold;               /*^ O, RRM_OAM_OLPC_PUCCH_SNR_THRESHOLD_PRESENT, H, 0, 255 ^*/
    S8                  olpc_p0_ue_pucch_range_start;               /*^ M, 0, B, -8, 7 ^*/
    S8                  olpc_p0_ue_pucch_range_end;                 /*^ M, 0, B, -8, 7 ^*/
}rrm_oam_olpc_pucch_config_params_t;


#define RRM_OAM_OLPC_PUSCH_CONFIG_PARAMS_PRESENT    0x01
#define RRM_OAM_OLPC_PUCCH_CONFIG_PARAMS_PRESENT    0x02
#define RRM_OAM_UL_PATHLOSS_THRESHOLD_PRESENT       0x04
#define RRM_OAM_UE_HO_COUNT_THRESHOLD_PRESENT       0x08
#define RRM_OAM_MIN_UE_POWER_PRESENT                0x10
typedef struct _rrm_oam_olpc_config_params_t
{
    rrm_bitmask_t       bitmask;                   /*^ BITMASK ^*/
    rrm_oam_olpc_pusch_config_params_t  rrm_olpc_pusch_config_params;   /*^ O, RRM_OAM_OLPC_PUSCH_CONFIG_PARAMS_PRESENT, N, 0, 0 ^*/
    rrm_oam_olpc_pucch_config_params_t  rrm_olpc_pucch_config_params;   /*^ O, RRM_OAM_OLPC_PUCCH_CONFIG_PARAMS_PRESENT, N, 0, 0 ^*/
    U8                  ul_pathloss_threshold;             /*^ O, RRM_OAM_UL_PATHLOSS_THRESHOLD_PRESENT, H, 0, 255 ^*/
    U8                  ue_handover_count_threshold;        /*^ O, RRM_OAM_UE_HO_COUNT_THRESHOLD_PRESENT, B, 1, 255 ^*/
    S8                  min_ue_power;                       /*^ O, RRM_OAM_MIN_UE_POWER_PRESENT, B, -40, 23 ^*/
...
/* SPR 20653 Fix Start */
#define RRM_OAM_OLPC_CONFIG_PARAMS_PRESENT       0x0200
/* SPR 20653 Fix End */
/*! \ rrm_oam_ran_t
...
typedef struct _rrm_oam_ran
{
    ...
    /* SPR 20653 Fix Start */
    rrm_oam_olpc_config_params_t    olpc_config_params; /*^ O, RRM_OAM_OLPC_CONFIG_PARAMS_PRESENT, N, 0, 0 ^*/
    /* SPR 20653 Fix End */
}rrm_oam_ran_t;
...
typedef struct _rrm_oam_rrmc_mac_config
{
    ...
    /* SPR 20653 Fix Start */
    rrm_bool_t  periodic_report_required;       /*^ O, RRM_OAM_PERIODIC_REPORT_REQUIRED_PRESENT, H, 0, 1 ^*/
    U32         periodic_report_periodicity;    /*^ O, RRM_OAM_PERIODIC_REPORT_PERIODICITY_PRESENT, L, 100, 0 ^*/
    U8          periodic_report_ue_batch_size;  /*^ O, RRM_OAM_PERIODIC_REPORT_UE_BATCH_SIZE_PRESENT, B, 1, 25 ^*/
    /* SPR 22420 Fix Start */
    U16         sampling_normal_time; /*^ O, RRM_OAM_SAMPLING_NORMAL_TIME, N, 0, 0^*/
    /* SPR 22420 Fix End */
    /* SPR 20653 Fix End */ 
}rrm_oam_rrmc_mac_config_t;
...
/*SPR 18654 START*/
#define RRM_OAM_DL_BW_FOR_CONTROL_PRBS                 0x10000
#define RRM_OAM_RB_FACTOR_FOR_BITRATE                  0x20000
/*SPR 18654 END*/
/* SPR 20653 Fix Start */
#define RRM_OAM_SRB_BIT_RATE_PRESENT                   0x40000
#define RRM_OAM_NGBR_THRESHOLD_PRESENT                 0x80000
#define RRM_OAM_NON_DEFAULT_BEARER_MULTIPLIER_PRESENT  0x100000
#define RRM_OAM_MIN_BITRATE_PRESENT                    0x200000
#define RRM_OAM_PRB_ESTIMATION_FACTOR_PRESENT          0x400000
/* SPR 20653 Fix End */ 
 ...
 *  \param dl_bw_for_control_prbs actual number of PRBs that will be reserved for control signaling 
 *  \param rb_factor_for_bitrate This factor is used for the estimation of the PRBs that will be used by a RAB e.g. prbs = bitrate*rb_factor_for_bitrate/3
...
typedef struct _rrm_oam_admission_control_info
{
    ...
    /*SPR 18654 START*/
    U8                           dl_bw_for_control_prbs;  /*^ O, RRM_OAM_DL_BW_FOR_CONTROL_PRBS, H, 0, 100 ^*/
    U16                           rb_factor_for_bitrate;  /*^ O, RRM_OAM_RB_FACTOR_FOR_BITRATE, L, 1, 0 ^*/
    /*SPR 18654 END*/
    ...
    /* SPR 20653 Fix Start */
    U64                             srb_bit_rate; /*^ O, RRM_OAM_SRB_BIT_RATE_PRESENT, N, 0, 0 ^*/
    U64                             minimum_bitrate; /*^ O, RRM_OAM_MIN_BITRATE_PRESENT, N, 0, 0 ^*/
    U8                              ngbr_threshold; /*^ O, RRM_OAM_NGBR_THRESHOLD_PRESENT, H, 0, 1 ^*/
    U8                              non_default_bearer_multiplier; /*^ O, RRM_OAM_NON_DEFAULT_BEARER_MULTIPLIER_PRESENT, H, 0, 1 ^*/
...
/* SPR 20653 Fix Start */
#define RRM_OAM_MIN_RI_PERIODICITY_PRESENT  0x0004
#define RRM_OAM_MIN_CQI_PERIODICITY_PRESENT 0x0008
#define RRM_OAM_MIN_SR_PERIODICITY_PRESENT  0x0010
#define NOM_PDSCH_RS_EPRE_OFFSET_PRESENT    0x0020
/* SPR 20653 Fix End */
...
typedef struct _rrm_oam_adl_pkt_scheduling_params_t
{
  ...
  /* SPR 20653 Fix Start */
  U8             min_ri_periodicity; /*^ O, RRM_OAM_MIN_RI_PERIODICITY_PRESENT, B, 1, 32 ^*/
  U8             min_cqi_periodicity;  /*^ O, RRM_OAM_MIN_CQI_PERIODICITY_PRESENT, H, 0, 6^*/
  U8             min_sr_periodicity;  /*^ O, RRM_OAM_MIN_SR_PERIODICITY_PRESENT, H, 0, 6^*/
  S8             nom_pdsch_rs_epre_offset; /*^ O, NOM_PDSCH_RS_EPRE_OFFSET_PRESENT, B, -1, 6^*/
  /* SPR 20653 Fix End */
}rrm_oam_adl_pkt_scheduling_params_t;
...
/* SPR 20653 Fix Start */
#define RRM_OAM_UL_MIMO_MODE_PARAMS_PRESENT    0x0200
#define RRM_OAM_TM_MODE_ADDITIONAL_INFO_PRESENT 0x0400
/* SPR 20653 Fix End */
/*TM mode 7-8 end*/
...
/*SPR_17664_start*/
   U8       num_of_cbsr; /*^ O, RRM_OAM_NUM_OF_CSR_PRESENT, B, 1, RRM_OAM_MAX_CODEBOOK_SUBSET ^*/
...
/*SPR_17664_end*/
   ...
   /*TM mode 7-8 end*/
   /* SPR 20653 Fix Start */
   rrm_oam_ul_mimo_mode_params_t        ul_mimo_mode_params; /*^ O, RRM_OAM_UL_MIMO_MODE_PARAMS_PRESENT, N, 0, 0 ^*/
   rrm_oam_tm_mode_additional_info_t    rrm_tm_mode_additional_info; /*^ O, RRM_OAM_TM_MODE_ADDITIONAL_INFO_PRESENT, N, 0, 0 ^*/
   /* SPR 20653 Fix End */
}rrm_oam_mimo_mode_params_t;
...
/* SPR 20653 Fix Start */
#define RRM_OAM_TIME_OF_STAY_THRESHOLD_PRESENT          0x01
#define RRM_OAM_MIN_NUM_OF_OSCILLATION_LOOP_PRESENT     0x02
#define RRM_OAM_MAX_LAST_VISITED_CELLS_SEARCHED_PRESENT 0x04
#define RRM_OAM_HO_OSCILLATION_CIO_OFFSET_PRESENT       0x08
typedef struct _rrm_oam_ho_oscillation_cfg_t
{
    rrm_bitmask_t       bitmask;                   /*^ BITMASK ^*/
    U16                 time_of_stay_threshold;             /*^ O, RRM_OAM_TIME_OF_STAY_THRESHOLD_PRESENT, H, 0, 4095 ^*/
    U8                  min_num_of_oscillation_loop;        /*^ O, RRM_OAM_MIN_NUM_OF_OSCILLATION_LOOP_PRESENT, H, 0, 255 ^*/
    U8                  max_last_visited_cells_searched;    /*^ O, RRM_OAM_MAX_LAST_VISITED_CELLS_SEARCHED_PRESENT, B, 1, 16 ^*/
    U8                  ho_oscillation_cio_offset;  /*^ O, RRM_OAM_HO_OSCILLATION_CIO_OFFSET_PRESENT, H, 0, 30 ^*/
}rrm_oam_ho_oscillation_cfg_t;

typedef struct _rrm_oam_block_cell_params_ho_t
{
    rrm_bitmask_t   bitmask; /*^ BITMASK ^*/
    rrmc_trigger_quantity_et trigger_quantity_for_block; /*^ M, 0, H, 0, 1^*/ /* rrmc_trigger_quantity_et */
...
/* SPR 20653 Fix Start */
#define RRM_OAM_HO_OSCILLATION_CFG_PRESENT                  0x08 
#define RRM_OAM_B1_EVENT_UTRAN_TRIGGER_QUANTITY_PRESENT     0x10
#define RRM_OAM_B2_EVENT_UTRAN_TRIGGER_QUANTITY_PRESENT     0x20
#define RRM_OAM_CSFB_BLIND_TIMER_DURATION_PRESENT           0x40
#define RRM_OAM_IRAT_OFFSET_PRESENT                         0x80
#define RRM_OAM_S1_DIRECT_FWD_PATH_AVAILABLE_PRESENT        0x100
/*SPR 21365 fix start*/
/* Lines Deleted */
#define RRM_OAM_UTRA_RNC_DIRECT_FWD_PATH_AVAILABLE_PRESENT  0x200
#define RRM_OAM_BLOCK_CELL_PARAMS_HO_PRESENT                0x400
/*SPR 21365 fix stop*/
/* SPR 20653 Fix End */
/* SPR 20635 Fix - SRVCC to GERAN - Starts */
#define RRM_OAM_UE_MEAS_DURATION_FOR_HO_PRESENT             0x800
...
typedef struct rrm_oam_ho_config_params_t
{
    ...
    /* SPR 20653 Fix Start */
    rrm_oam_ho_oscillation_cfg_t    ho_oscillation_cfg;
    /*^ O, RRM_OAM_HO_OSCILLATION_CFG_PRESENT, N, 0, 0^*/
    rrm_oam_block_cell_params_ho_t  block_cell_params_ho;
    /*^ O, RRM_OAM_BLOCK_CELL_PARAMS_HO_PRESENT, N, 0, 0^*/
    rrm_bool_t                      s1_direct_fwd_path_available;
    /*^ O, RRM_OAM_S1_DIRECT_FWD_PATH_AVAILABLE_PRESENT, H, 0, 1^*/
    rrm_bool_t                      utra_rnc_direct_fwd_path_available;
    /*^ O, RRM_OAM_UTRA_RNC_DIRECT_FWD_PATH_AVAILABLE_PRESENT, H, 0, 1^*/
    U8                              b1_event_utran_trigger_quantity;
    /*^ O, RRM_OAM_B1_EVENT_UTRAN_TRIGGER_QUANTITY_PRESENT, H, 0, 1^*/
    U8                              b2_event_utran_trigger_quantity;
    /*^ O, RRM_OAM_B2_EVENT_UTRAN_TRIGGER_QUANTITY_PRESENT, H, 0, 1^*/
    /*SPR 21365 fix start*/
    /* Lines Deleted */
    /*SPR 21365 fix stop*/
    U16                             csfb_blind_timer_duration;
    /*^ O, RRM_OAM_CSFB_BLIND_TIMER_DURATION_PRESENT, H, 0, 65535^*/
    S8                              irat_offset;
    /*^ O, RRM_OAM_IRAT_OFFSET_PRESENT, B, -15, 15^*/
    /* SPR 20653 Fix End */
    /* SPR 20635 Fix - SRVCC to GERAN - Starts */
...
#define RRM_OAM_MAX_DELTA_SINR_TO_TCP_MAP_PUSCH          4
...
#define RRM_OAM_START_BLER_PRESENT      0x01
#define RRM_OAM_END_BLER_PRESENT        0x02
#define RRM_OAM_PUCCH_TPC_PRESENT       0x04
typedef struct _rrm_oam_delta_bler_to_tpc_map_for_pucch_info_t
{
    rrm_bitmask_t   bitmask;/*^ BITMASK ^*/
    S16             start_bler;   /*^ O, RRM_OAM_START_BLER_PRESENT, B, -100, 100^*/
    S16             end_bler;     /*^ O, RRM_OAM_END_BLER_PRESENT, B, -100, 100^*/
    S8             pucch_tpc;    /*^ O, RRM_OAM_PUCCH_TPC_PRESENT, B, -1, 3^*/
}rrm_oam_delta_bler_to_tpc_map_for_pucch_info_t;

#define RRM_OAM_MAX_NUM_TPC_FOR_PUCCH                4
...
#define RRM_OAM_MAX_NUM_TPC_FOR_PUCCH    4
#define RRM_OAM_PUCCH_SINR_TARGET_PRESENT   0x01
typedef struct _rrm_oam_delta_sinr_to_tpc_map_pucch_info_t
{
    rrm_bitmask_t   bitmask;/*^ BITMASK ^*/
    U8             pucch_sinr_target;  /*^ O, RRM_OAM_PUCCH_SINR_TARGET_PRESENT, H, 0, 255^*/
    U8              count;              /*^ M, 0, H, 1, 4^*/
...
/* SPR 20653 Fix Start */
#define RRM_OAM_REF_SIG_POWER_RAMPING_STEP_PRESENT              0x040000
#define RRM_OAM_PA_RAMPING_STEP_PRESENT                         0x080000
#define RRM_OAM_SRS_SUBBAND_GROUP_SIZE_PRESENT                  0x100000
#define RRM_OAM_INITIAL_UE_LOCATION_PRESENT                     0x200000
#define RRM_OAM_TPC_INFO_PRESENT                                0x400000
#define RRM_OAM_REPORT_CONFIG_INFO_PRESENT                      0x800000
/* SPR 20653 Fix End */
...
typedef struct _rrm_oam_dynamic_icic_info_t
{
    ...
    /* SPR 20653 Fix Start */
    U8      ref_sig_powr_ramping_step;  /*^ O, RRM_OAM_REF_SIG_POWER_RAMPING_STEP_PRESENT, H, 0, 90^*/
    U8      p_a_ramping_step;           /*^ O, RRM_OAM_PA_RAMPING_STEP_PRESENT, H, 0, 7^*/
    U8      initial_ue_location;        /*^ O, RRM_OAM_INITIAL_UE_LOCATION_PRESENT, H, 0, 1^*/
    U32     srs_subband_group_size;     /*^ O, RRM_OAM_SRS_SUBBAND_GROUP_SIZE_PRESENT, B, 1, 8^*/
    rrm_oam_tpc_info_t                      tpc_info;  /*^ O, RRM_OAM_TPC_INFO_PRESENT, N, 0, 0^*/ 
    rrm_oam_report_config_info_t            report_config_info;/*^ O, RRM_OAM_REPORT_CONFIG_INFO_PRESENT, N, 0, 0^*/
    /* SPR 20653 Fix End */
...
/* SPR 20653 Fix Start */
#define RRM_OAM_UL_POWER_CONTROL_DEDICATED_PRESENT 0x0004
/* SPR 20653 Fix End */
...
typedef struct _rrm_oam_power_control_params_t
{
   ...
   /* SPR 20653 Fix Start */
   rrm_oam_uplink_power_control_dedicated_info_t uplink_power_control_dedicated; /*^ O, RRM_OAM_UL_POWER_CONTROL_DEDICATED_PRESENT, N, 0, 0 ^*/
   /* SPR 20653 Fix End */
}rrm_oam_power_control_params_t; 
...
/* SPR 20653 Fix Start */
#define RRM_OAM_ACTIVE_UE_REPORTS_TIMER_PRESENT     0x02
/* SPR 20653 Fix End */
...
typedef struct rrm_oam_max_ue_schedule_dl_ul_t
{
    ...
    /* SPR 20653 Fix Start */
    U8               active_ue_reports_timer;           /*^ O, RRM_OAM_ACTIVE_UE_REPORTS_TIMER_PRESENT, B, 1, 255 ^*/
    /* SPR 20653 Fix End */
}rrm_oam_max_ue_schedule_dl_ul_t;
/*SPR 19119 Fix End*/
...
#define RRM_OAM_CA_ASSOCIATED_LAYER2_INST_FIELD_PRESENT 0x0040
#define RRM_OAM_MEAS_CYCLE_SCELL_PRESENT                0x0080
#define RRM_OAM_IS_LAA_ELIGIBLE_INFO_PRESENT            0x0100              /*LAA changes by jagritee **/
/*  LAA Rel13 Code + */
#define RRM_OAM_LAA_SCELL_CONFIGURATION_INFO_PRESENT    0x0200
#define RRM_OAM_DMTC_CONFIGURATION_INFO_PRESENT         0x0400
/*  LAA Rel13 Code - */
...
typedef struct _rrm_oam_eicic_info_t
{
    ...
    /*eICIC_changes_start*/
    U8                                  eligible_ue;                /*^ O, RRM_OAM_EICIC_ELIGIBLE_UE_PRESENT, B, 1, 100 ^*/
    /*eICIC_changes_end*/
...
/* SPR 18641_18843 fix end */
/* SPR 21371 Start */
#define RRM_OAM_ASSOCIATED_LAYER2_INST_FIELD_PRESENT        0x8000000
/* SPR 21371 End */
/* SPR 22325 Start */
#define RRM_OAM_ASSOCIATED_PDCP_INST_FIELD_PRESENT         0x10000000
#define RRM_OAM_ASSOCIATED_RLC_INST_FIELD_PRESENT           0x20000000
#define RRM_OAM_ASSOCIATED_MAC_INST_FIELD_PRESENT          0x40000000
#define RRM_OAM_LWA_INFO_PRESENT                           0x80000000
/* SPR 22325 End */
/* SPR 22248 MBMS Changes Start */
