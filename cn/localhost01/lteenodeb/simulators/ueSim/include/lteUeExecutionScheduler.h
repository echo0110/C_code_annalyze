 ...
 ****************************************************************************
 *
 *  $Id: lteUeExecutionScheduler.h,v 1.1.1.1.6.2 2010/08/02 08:57:19 gur20491 Exp $
 *
 ****************************************************************************
 *
 ...
 * Revision 1.1.1.1.6.2  2010/08/02 08:57:19  gur20491
...
#define PHY_CREATE_UE_ENTITY_NB_REQ  11 
#define PHY_CREATE_UE_ENTITY_NB_CNF 12
...
extern UInt32 rlcHandleComChDataFromMac();
extern UInt32 rlcHandleComChTxOppurtunity();
...
#endif
extern UInt32 rlcHandleControlPduForRlcAm(UInt64 sQCount);
/* SPR 609 changes end */
#endif/* PHYSIM_H*/
