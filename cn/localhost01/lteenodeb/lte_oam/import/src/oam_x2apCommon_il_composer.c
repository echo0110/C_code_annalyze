 ...
 ****************************************************************************
 *
 *  File Description : The file oam_x2apCommon_il_composer.c contains the definitions 
...
static
oam_return_et
oam_compose_x2ap_plmn_identity
(
    UInt8  **pp_buffer,
    x2ap_plmn_identity_t *p_x2ap_plmn_identity
);
...
static
oam_return_et
oam_compose_x2ap_broadcast_plmn
(
    UInt8  **pp_buffer,
    x2ap_broadcast_plmn_t *p_x2ap_broadcast_plmn
);
...
static
oam_return_et
oam_compose_x2ap_special_subframe_info
(
    UInt8  **pp_buffer,
    x2ap_special_subframe_info_t *p_x2ap_special_subframe_info
);
...
static
oam_return_et
oam_compose_x2ap_choice_eutra_mode
(
    UInt8  **pp_buffer,
    x2ap_choice_eutra_mode_t *p_x2ap_choice_eutra_mode
);
...
static
oam_return_et
oam_compose_x2ap_choice_eutra_mode_info
(
    UInt8  **pp_buffer,
    x2ap_choice_eutra_mode_info_t *p_x2ap_choice_eutra_mode_info
);
...
static
oam_return_et
oam_compose_x2ap_prach_configuration_info
(
    UInt8  **pp_buffer,
    x2ap_prach_configuration_info_t *p_x2ap_prach_configuration_info
);
...
static
oam_return_et
oam_compose_x2ap_subframe_allocation
(
    UInt8  **pp_buffer,
    x2ap_subframe_allocation_t *p_x2ap_subframe_allocation
);
...
static
oam_return_et
oam_compose_x2ap_mbsfn_subframe_info
(
    UInt8  **pp_buffer,
    x2ap_mbsfn_subframe_info_t *p_x2ap_mbsfn_subframe_info
);
...
static
oam_return_et
oam_compose_x2ap_served_cell_info
(
    UInt8  **pp_buffer,
    x2ap_served_cell_info_t *p_x2ap_served_cell_info
);
...
static
oam_return_et
oam_compose_x2ap_nbour_cell_info
(
    UInt8  **pp_buffer,
    x2ap_nbour_cell_info_t *p_x2ap_nbour_cell_info
);
...
static
oam_return_et
oam_compose_x2ap_served_cell_info_arr
(
    UInt8  **pp_buffer,
    x2ap_served_cell_info_arr_t *p_x2ap_served_cell_info_arr
);
...
static
oam_return_et
oam_compose_x2ap_served_cells_to_add_list
(
    UInt8  **pp_buffer,
    x2ap_served_cells_to_add_list_t *p_x2ap_served_cells_to_add_list
);
...
static
oam_return_et
oam_compose_x2ap_served_cells_to_modify_info
(
    UInt8  **pp_buffer,
    x2ap_served_cells_to_modify_info_t *p_x2ap_served_cells_to_modify_info
);
...
static
oam_return_et
oam_compose_x2ap_served_cells_to_modify_list
(
    UInt8  **pp_buffer,
    x2ap_served_cells_to_modify_list_t *p_x2ap_served_cells_to_modify_list
);
...
static
oam_return_et
oam_compose_x2ap_served_cells_to_delete_list
(
    UInt8  **pp_buffer,
    x2ap_served_cells_to_delete_list_t *p_x2ap_served_cells_to_delete_list
);
...
static
oam_return_et
oam_compose_x2ap_gu_group_id_list
(
    UInt8  **pp_buffer,
    x2ap_gu_group_id_list_t *p_x2ap_gu_group_id_list
);
...
static
oam_return_et
oam_compose_x2ap_neigh_ecgi_enb_id_map_info
(
    UInt8  **pp_buffer,
    x2ap_neigh_ecgi_enb_id_map_info_t *p_x2ap_neigh_ecgi_enb_id_map_info
);
...
static
oam_return_et
oam_compose_x2ap_neigh_ecgi_enb_id_map_list
(
    UInt8  **pp_buffer,
    x2ap_neigh_ecgi_enb_id_map_list_t *p_x2ap_neigh_ecgi_enb_id_map_list
);
...
static
oam_return_et
oam_compose_x2_trans_layer_addrs
(
    UInt8  **pp_buffer,
    x2_trans_layer_addrs_t *p_x2_trans_layer_addrs
);
...
static
oam_return_et
oam_compose_x2_extend_trans_layer_addrs
(
    UInt8  **pp_buffer,
    x2_extend_trans_layer_addrs_t *p_x2_extend_trans_layer_addrs
);
...
static
oam_return_et
oam_compose_x2ap_enb_comm_info_list
(
    UInt8  **pp_buffer,
    x2ap_enb_comm_info_list_t *p_x2ap_enb_comm_info_list
);
...
static
oam_return_et
oam_compose_x2ap_cell_activation_info
(
    UInt8  **pp_buffer,
    x2ap_cell_activation_info_t *p_x2ap_cell_activation_info
);
...
static
oam_return_et
oam_compose_x2ap_cell_activation_resp
(
    UInt8  **pp_buffer,
    x2ap_cell_activation_resp_t *p_x2ap_cell_activation_resp
);
...
static
oam_return_et
oam_compose_x2ap_mobility_change_info
(
    UInt8  **pp_buffer,
    x2ap_mobility_change_info_t *p_x2ap_mobility_change_info
);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_enb_config_update_req != PNULL);
...
)
{
    ...
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_enb_config_update_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_enb_config_update_req->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_enb_config_update_req->num_peer_enb, "num_peer_enb");
    *pp_buffer += sizeof(p_x2ap_enb_config_update_req->num_peer_enb);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_enb_config_update_req->num_peer_enb; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_config_update_req->enb_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cells_to_add_list(pp_buffer, &p_x2ap_enb_config_update_req->add_served_cell))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cells_to_modify_list(pp_buffer, &p_x2ap_enb_config_update_req->mod_served_cell))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cells_to_delete_list(pp_buffer, &p_x2ap_enb_config_update_req->del_served_cell))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_gu_group_id_list(pp_buffer, &p_x2ap_enb_config_update_req->add_gu_id))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_gu_group_id_list(pp_buffer, &p_x2ap_enb_config_update_req->delete_gu_id))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_neigh_ecgi_enb_id_map_list(pp_buffer, &p_x2ap_enb_config_update_req->neigh_ecgi_enb_id_map))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_enb_config_update_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_REQ", src_module_id, dest_module_id);
    ...
    /* Fill CSPL header */
    oam_construct_api_header(p_x2apCommon_msg, RRC_VERSION_ID, src_module_id,
        dest_module_id, X2AP_ENB_CONFIG_UPDATE_REQ, msg_api_length);

    /* Fill interface header */
    p_x2apCommon_msg = p_x2apCommon_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_x2apCommon_msg, transaction_id, src_module_id,
        dest_module_id, X2AP_ENB_CONFIG_UPDATE_REQ, msg_length, cell_index);

    /* Fill X2AP_ENB_CONFIG_UPDATE_REQ message */
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_enb_config_update_req(&p_x2apCommon_msg, p_x2ap_enb_config_update_req))
    {
...
)
{
    ...
    *pp_buffer += sizeof(p_x2_enb_id_info->presence_bitmask);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_macro_enb_id(pp_buffer, &p_x2_enb_id_info->macro_enb_id))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_home_enb_id(pp_buffer, &p_x2_enb_id_info->home_enb_id))
    {
        return OAM_FAILURE;
    }
    }
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_plmn_identity(pp_buffer, &p_x2_gb_enb_id->plmn_identity))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_enb_id_info(pp_buffer, &p_x2_gb_enb_id->enb_id))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    *pp_buffer += sizeof(p_x2ap_broadcast_plmn->num_bcast_plmn_id);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_broadcast_plmn->num_bcast_plmn_id; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_plmn_identity(pp_buffer, &p_x2ap_broadcast_plmn->plmn_identity[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_earfcn(pp_buffer, &p_x2ap_fdd_info->ul_earfcn))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_earfcn(pp_buffer, &p_x2ap_fdd_info->dl_earfcn))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_earfcn(pp_buffer, &p_x2ap_tdd_info->earfcn))
    {
        return OAM_FAILURE;
    }
    ...
    *pp_buffer += sizeof(p_x2ap_tdd_info->subframe_assn);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_special_subframe_info(pp_buffer, &p_x2ap_tdd_info->special_subframe_info))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    *pp_buffer += sizeof(p_x2ap_choice_eutra_mode->bitmask);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_fdd_info(pp_buffer, &p_x2ap_choice_eutra_mode->fdd_info))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_tdd_info(pp_buffer, &p_x2ap_choice_eutra_mode->tdd_info))
    {
        return OAM_FAILURE;
    }
    }
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_choice_eutra_mode(pp_buffer, &p_x2ap_choice_eutra_mode_info->choice_eutra_mode))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    *pp_buffer += sizeof(p_x2ap_mbsfn_info->radioframe_alloc_offset);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_subframe_allocation(pp_buffer, &p_x2ap_mbsfn_info->subframe_alloc))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    *pp_buffer += sizeof(p_x2ap_mbsfn_subframe_info->num_mbsfn);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_mbsfn_subframe_info->num_mbsfn; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_mbsfn_info(pp_buffer, &p_x2ap_mbsfn_subframe_info->mbsfn_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_served_cell_info != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_served_cell_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_served_cell_info->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_served_cell_info->pci, "pci");
    *pp_buffer += sizeof(p_x2ap_served_cell_info->pci);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_served_cell_info->cell_id, "cell_id");
    *pp_buffer += sizeof(p_x2ap_served_cell_info->cell_id);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_served_cell_info->tac[loop], "tac[]");
            *pp_buffer += sizeof(UInt8);
        }
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_broadcast_plmn(pp_buffer, &p_x2ap_served_cell_info->bcast_plmn_info))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_choice_eutra_mode_info(pp_buffer, &p_x2ap_served_cell_info->choice_eutra_mode))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_served_cell_info->num_antenna_port, "num_antenna_port");
    *pp_buffer += sizeof(p_x2ap_served_cell_info->num_antenna_port);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_prach_configuration_info(pp_buffer, &p_x2ap_served_cell_info->prach_config))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mbsfn_subframe_info(pp_buffer, &p_x2ap_served_cell_info->mbsfn_subframe_info))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_served_cell_info->csg_identity[loop], "csg_identity[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
    }
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_plmn_identity(pp_buffer, &p_x2ap_ecgi->plmn_identity))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_nbour_info != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_nbour_info->ecgi))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_x2ap_nbour_info->pci, "pci");
    *pp_buffer += sizeof(p_x2ap_nbour_info->pci);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_earfcn(pp_buffer, &p_x2ap_nbour_info->earfcn))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_nbour_cell_info != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_nbour_cell_info->num_neighbour_cell, "num_neighbour_cell");
    *pp_buffer += sizeof(p_x2ap_nbour_cell_info->num_neighbour_cell);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_nbour_cell_info->num_neighbour_cell; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_nbour_info(pp_buffer, &p_x2ap_nbour_cell_info->neighbour_info_arr[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_served_cell_info_arr != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cell_info(pp_buffer, &p_x2ap_served_cell_info_arr->cell_info))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_nbour_cell_info(pp_buffer, &p_x2ap_served_cell_info_arr->nbour_cell_info))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_served_cells_to_add_list != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_served_cells_to_add_list->num_served_cell, "num_served_cell");
    *pp_buffer += sizeof(p_x2ap_served_cells_to_add_list->num_served_cell);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_served_cells_to_add_list->num_served_cell; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_served_cell_info_arr(pp_buffer, &p_x2ap_served_cells_to_add_list->cell_list[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_served_cells_to_modify_info != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_served_cells_to_modify_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_served_cells_to_modify_info->bitmask);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_served_cells_to_modify_info->old_cell_id, "old_cell_id");
    *pp_buffer += sizeof(p_x2ap_served_cells_to_modify_info->old_cell_id);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cell_info_arr(pp_buffer, &p_x2ap_served_cells_to_modify_info->served_cell_info))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_served_cells_to_modify_info->deactivation_ind, "deactivation_ind");
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_served_cells_to_modify_list != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_served_cells_to_modify_list->num_served_cell, "num_served_cell");
    *pp_buffer += sizeof(p_x2ap_served_cells_to_modify_list->num_served_cell);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_served_cells_to_modify_list->num_served_cell; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_served_cells_to_modify_info(pp_buffer, &p_x2ap_served_cells_to_modify_list->cell_list[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_served_cells_to_delete_list != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_served_cells_to_delete_list->num_served_cell, "num_served_cell");
    *pp_buffer += sizeof(p_x2ap_served_cells_to_delete_list->num_served_cell);
    ...
    /* Compose OCTET_STRING VARIABLE of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_served_cells_to_delete_list->cell_id_list[loop], "cell_id_list[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_plmn_identity(pp_buffer, &p_x2ap_gu_group_id->plmn_id))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_gu_group_id_list != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_gu_group_id_list->num_gu_group_id, "num_gu_group_id");
    *pp_buffer += sizeof(p_x2ap_gu_group_id_list->num_gu_group_id);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_gu_group_id_list->num_gu_group_id; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_gu_group_id(pp_buffer, &p_x2ap_gu_group_id_list->gu_id_list[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_neigh_ecgi_enb_id_map_info != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_neigh_ecgi_enb_id_map_info->ecgi))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_neigh_ecgi_enb_id_map_info->enb_id))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_neigh_ecgi_enb_id_map_list != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_neigh_ecgi_enb_id_map_list->neigh_info_count, "neigh_info_count");
    *pp_buffer += sizeof(p_x2ap_neigh_ecgi_enb_id_map_list->neigh_info_count);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_neigh_ecgi_enb_id_map_list->neigh_info_count; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_neigh_ecgi_enb_id_map_info(pp_buffer, &p_x2ap_neigh_ecgi_enb_id_map_list->neigh_ecgi_enb_id_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_enb_config_update_resp != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_enb_config_update_resp->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_enb_config_update_resp->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_config_update_resp->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_config_update_resp->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_enb_config_update_resp->response, "response");
    *pp_buffer += sizeof(p_x2ap_enb_config_update_resp->response);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cause(pp_buffer, &p_x2ap_enb_config_update_resp->cause))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_enb_config_update_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_RES", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_enb_config_update_resp(&p_x2apCommon_msg, p_x2ap_enb_config_update_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_cause != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_cause->type, "type");
    *pp_buffer += sizeof(p_x2ap_cause->type);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_cause->value, "value");
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_enb_config_update_ind != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_enb_config_update_ind->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_enb_config_update_ind->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_config_update_ind->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_config_update_ind->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cells_to_add_list(pp_buffer, &p_x2ap_enb_config_update_ind->add_served_cell))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cells_to_modify_list(pp_buffer, &p_x2ap_enb_config_update_ind->mod_served_cell))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_served_cells_to_delete_list(pp_buffer, &p_x2ap_enb_config_update_ind->del_served_cell))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_gu_group_id_list(pp_buffer, &p_x2ap_enb_config_update_ind->add_gu_id))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_gu_group_id_list(pp_buffer, &p_x2ap_enb_config_update_ind->delete_gu_id))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_enb_config_update_ind
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_IND", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_enb_config_update_ind(&p_x2apCommon_msg, p_x2ap_enb_config_update_ind))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_reset_req != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_reset_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_reset_req->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_reset_req->gb_enb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cause(pp_buffer, &p_x2ap_reset_req->cause))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_reset_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_RESET_REQ", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_reset_req(&p_x2apCommon_msg, p_x2ap_reset_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_reset_resp != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_reset_resp->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_reset_resp->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_reset_resp->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_reset_resp->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_reset_resp->response, "response");
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_reset_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_RESET_RES", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_reset_resp(&p_x2apCommon_msg, p_x2ap_reset_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_reset_ind != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_reset_ind->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_reset_ind->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_reset_ind->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_reset_ind->enb2_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cause(pp_buffer, &p_x2ap_reset_ind->cause))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_reset_ind
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_RESET_IND", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_reset_ind(&p_x2apCommon_msg, p_x2ap_reset_ind))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_add_enb_req != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_add_enb_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_add_enb_req->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_add_enb_req->num_peer_enb, "num_peer_enb");
    *pp_buffer += sizeof(p_x2ap_add_enb_req->num_peer_enb);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_add_enb_req->num_peer_enb; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2_enb_comm_info(pp_buffer, &p_x2ap_add_enb_req->enb_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_add_enb_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ADD_ENB_REQ", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_add_enb_req(&p_x2apCommon_msg, p_x2ap_add_enb_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    *pp_buffer += sizeof(p_x2_extend_trans_layer_addrs->bitmask);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_trans_layer_addrs(pp_buffer, &p_x2_extend_trans_layer_addrs->ipsec_trans_layer_addrs))
    {
        return OAM_FAILURE;
    }
    }
    ...
    *pp_buffer += sizeof(p_x2_extend_trans_layer_addrs->num_tlas);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2_extend_trans_layer_addrs->num_tlas; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2_trans_layer_addrs(pp_buffer, &p_x2_extend_trans_layer_addrs->gtp_trans_layer_addrs[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    *pp_buffer += sizeof(p_x2_enb_comm_info->num_ip_addr);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2_enb_comm_info->num_ip_addr; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2_ip_addr(pp_buffer, &p_x2_enb_comm_info->ip_addr[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    *pp_buffer += sizeof(p_x2_enb_comm_info->num_ipv6_addr);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2_enb_comm_info->num_ipv6_addr; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2_ipv6_addr(pp_buffer, &p_x2_enb_comm_info->ipv6_addr[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    *pp_buffer += sizeof(p_x2_enb_comm_info->num_tlas);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2_enb_comm_info->num_tlas; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2_extend_trans_layer_addrs(pp_buffer, &p_x2_enb_comm_info->extend_trans_layer_addrs[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_add_enb_res != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_add_enb_res->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_add_enb_res->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_add_enb_res->gb_enb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_enb_comm_info_list(pp_buffer, &p_x2ap_add_enb_res->success_enb_list))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_enb_comm_info_list(pp_buffer, &p_x2ap_add_enb_res->failure_enb_list))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_add_enb_res
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ADD_ENB_RES", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_add_enb_res(&p_x2apCommon_msg, p_x2ap_add_enb_res))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_enb_comm_info_list != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_enb_comm_info_list->num_peer_enb, "num_peer_enb");
    *pp_buffer += sizeof(p_x2ap_enb_comm_info_list->num_peer_enb);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_enb_comm_info_list->num_peer_enb; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2_enb_comm_info(pp_buffer, &p_x2ap_enb_comm_info_list->enb_comm_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_delete_enb_req != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_delete_enb_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_delete_enb_req->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_delete_enb_req->gb_enb_id))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_delete_enb_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_DEL_ENB_REQ", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_delete_enb_req(&p_x2apCommon_msg, p_x2ap_delete_enb_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_delete_enb_res != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_delete_enb_res->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_delete_enb_res->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_delete_enb_res->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_delete_enb_res->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_delete_enb_res->response, "response");
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_delete_enb_res
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_DEL_ENB_RES", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_delete_enb_res(&p_x2apCommon_msg, p_x2ap_delete_enb_res))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_enb_link_up_ind != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_enb_link_up_ind->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_enb_link_up_ind->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_link_up_ind->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_link_up_ind->enb2_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_enb_comm_info(pp_buffer, &p_x2ap_enb_link_up_ind->enb_comm_info))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_enb_link_up_ind->num_served_cell, "num_served_cell");
    *pp_buffer += sizeof(p_x2ap_enb_link_up_ind->num_served_cell);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_enb_link_up_ind->num_served_cell; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_served_cell_info_arr(pp_buffer, &p_x2ap_enb_link_up_ind->served_cell_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_gu_group_id_list(pp_buffer, &p_x2ap_enb_link_up_ind->gu_group_id))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_enb_link_up_ind
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ENB_LINK_UP_IND", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_enb_link_up_ind(&p_x2apCommon_msg, p_x2ap_enb_link_up_ind))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_enb_link_down_ind != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_enb_link_down_ind->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_enb_link_down_ind->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_link_down_ind->enb1_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_link_down_ind->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_enb_comm_info(pp_buffer, &p_x2ap_enb_link_down_ind->enb_comm_info))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_enb_link_down_ind
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ENB_LINK_DOWN_IND", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_enb_link_down_ind(&p_x2apCommon_msg, p_x2ap_enb_link_down_ind))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_enb_config_update_wait_ind != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_enb_config_update_wait_ind->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_enb_config_update_wait_ind->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_config_update_wait_ind->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_enb_config_update_wait_ind->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_enb_config_update_wait_ind->time_to_wait, "time_to_wait");
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_enb_config_update_wait_ind
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_ENB_CONFIG_UPDATE_WAIT_IND", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_enb_config_update_wait_ind(&p_x2apCommon_msg, p_x2ap_enb_config_update_wait_ind))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_ho_report_ind != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_ho_report_ind->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_ho_report_ind->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_ho_report_ind->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_ho_report_ind->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_x2ap_ho_report_ind->ho_report_type, "ho_report_type");
    *pp_buffer += sizeof(p_x2ap_ho_report_ind->ho_report_type);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cause(pp_buffer, &p_x2ap_ho_report_ind->ho_cause))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_ho_report_ind->src_ecgi))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_ho_report_ind->fail_cell_ecgi))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_ho_report_ind->re_est_cell_ecgi))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_ho_report_ind
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_HO_REPORT_IND", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_ho_report_ind(&p_x2apCommon_msg, p_x2ap_ho_report_ind))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_peer_cell_activation_req != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_peer_cell_activation_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_peer_cell_activation_req->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_peer_cell_activation_req->gb_enb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cell_activation_info(pp_buffer, &p_x2ap_peer_cell_activation_req->peer_cell_activation_info))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_peer_cell_activation_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_PEER_CELL_ACTIVATION_REQ", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_peer_cell_activation_req(&p_x2apCommon_msg, p_x2ap_peer_cell_activation_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_cell_activation_info != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_cell_activation_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_cell_activation_info->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_cell_activation_info->num_served_cell, "num_served_cell");
    *pp_buffer += sizeof(p_x2ap_cell_activation_info->num_served_cell);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_cell_activation_info->num_served_cell; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_cell_activation_info->served_cell_list[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_peer_cell_activation_resp != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cell_activation_resp(pp_buffer, &p_x2ap_peer_cell_activation_resp->peer_cell_activation_resp))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_peer_cell_activation_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_PEER_CELL_ACTIVATION_RESP", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_peer_cell_activation_resp(&p_x2apCommon_msg, p_x2ap_peer_cell_activation_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_cell_activation_resp != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_cell_activation_resp->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_cell_activation_resp->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_cell_activation_resp->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_cell_activation_resp->enb2_gb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_cell_activation_resp->response, "response");
    *pp_buffer += sizeof(p_x2ap_cell_activation_resp->response);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_cell_activation_resp->num_served_cell, "num_served_cell");
    *pp_buffer += sizeof(p_x2ap_cell_activation_resp->num_served_cell);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_x2ap_cell_activation_resp->num_served_cell; loop++)
        {
            if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_cell_activation_resp->served_cell_list[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cause(pp_buffer, &p_x2ap_cell_activation_resp->cause))
    {
        return OAM_FAILURE;
    }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_cell_activation_req != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_cell_activation_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_cell_activation_req->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_cell_activation_req->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_cell_activation_req->enb2_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cell_activation_info(pp_buffer, &p_x2ap_cell_activation_req->cell_activation_info))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_cell_activation_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_CELL_ACTIVATION_REQ", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_cell_activation_req(&p_x2apCommon_msg, p_x2ap_cell_activation_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_cell_activation_response != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cell_activation_resp(pp_buffer, &p_x2ap_cell_activation_response->cell_activation_resp))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_cell_activation_response
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_CELL_ACTIVATION_RESP", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_cell_activation_response(&p_x2apCommon_msg, p_x2ap_cell_activation_response))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mobility_change_req != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_mobility_change_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_mobility_change_req->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_mobility_change_req->gb_enb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mobility_change_info(pp_buffer, &p_x2ap_mobility_change_req->mobility_change_info))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_mobility_change_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_CHANGE_REQ", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_mobility_change_req(&p_x2apCommon_msg, p_x2ap_mobility_change_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mob_param != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_SINT8(*pp_buffer, &p_x2ap_mob_param->handover_trigger_change, "handover_trigger_change");
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mobility_change_info != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_mobility_change_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_mobility_change_info->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_mobility_change_info->enb1_cell_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_mobility_change_info->enb2_cell_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mob_param(pp_buffer, &p_x2ap_mobility_change_info->enb1_mob_param))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mob_param(pp_buffer, &p_x2ap_mobility_change_info->enb2_mob_param))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cause(pp_buffer, &p_x2ap_mobility_change_info->cause))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mobility_change_resp != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mob_ch_resp(pp_buffer, &p_x2ap_mobility_change_resp->mobility_change_resp))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_mobility_change_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_CHANGE_RESP", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_mobility_change_resp(&p_x2apCommon_msg, p_x2ap_mobility_change_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mob_range != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_mob_range->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_mob_range->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_SINT8(*pp_buffer, &p_x2ap_mob_range->ho_trigger_change_lower_limit, "ho_trigger_change_lower_limit");
    *pp_buffer += sizeof(p_x2ap_mob_range->ho_trigger_change_lower_limit);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_SINT8(*pp_buffer, &p_x2ap_mob_range->ho_trigger_change_upper_limit, "ho_trigger_change_upper_limit");
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mob_ch_resp != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_mob_ch_resp->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_mob_ch_resp->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_mob_ch_resp->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_mob_ch_resp->enb2_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_mob_ch_resp->enb1_cell_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_ecgi(pp_buffer, &p_x2ap_mob_ch_resp->enb2_cell_id))
    {
        return OAM_FAILURE;
    }

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_x2ap_mob_ch_resp->response, "response");
    *pp_buffer += sizeof(p_x2ap_mob_ch_resp->response);
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_cause(pp_buffer, &p_x2ap_mob_ch_resp->cause))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mob_range(pp_buffer, &p_x2ap_mob_ch_resp->enb2_mob_param_mod_range))
    {
        return OAM_FAILURE;
    }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mobility_setting_change_req != PNULL);
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_x2ap_mobility_setting_change_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_x2ap_mobility_setting_change_req->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_mobility_setting_change_req->enb1_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2_gb_enb_id(pp_buffer, &p_x2ap_mobility_setting_change_req->enb2_gb_id))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mobility_change_info(pp_buffer, &p_x2ap_mobility_setting_change_req->mobility_change_info))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_mobility_setting_change_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_SETTING_CHANGE_REQ", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_mobility_setting_change_req(&p_x2apCommon_msg, p_x2ap_mobility_setting_change_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_x2ap_mobility_setting_change_resp != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == oam_compose_x2ap_mob_ch_resp(pp_buffer, &p_x2ap_mobility_setting_change_resp->mobility_setting_change_resp))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_x2apCommon_send_x2ap_mobility_setting_change_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):X2AP_MOBILITY_SETTING_CHANGE_RESP", src_module_id, dest_module_id);
    ...
    p_x2apCommon_msg = p_x2apCommon_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == oam_compose_x2ap_mobility_setting_change_resp(&p_x2apCommon_msg, p_x2ap_mobility_setting_change_resp))
    {
        oam_mem_free(p_msg,&oam_error);
