 ...
 ****************************************************************************
 *
 *  File Description : The file oam_s1ap_il_composer.c contains the definitions 
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_enb_config_update != PNULL);
...
)
{
    ...
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_enb_config_update->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_oam_enb_config_update->bitmask);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_enb_config_update->enb_name[loop], "enb_name[]");
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_supp_ta_list(pp_buffer, &p_s1ap_oam_enb_config_update->supp_ta_list))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_csg_id_list(pp_buffer, &p_s1ap_oam_enb_config_update->csg_id_list))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_oam_enb_config_update->default_paging_drx, "default_paging_drx");
    *pp_buffer += sizeof(p_s1ap_oam_enb_config_update->default_paging_drx);
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_id_list_info(pp_buffer, &p_s1ap_oam_enb_config_update->s1ap_oam_mme_id_list))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_enb_config_update
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_ENB_CONFIG_UPDATE", src_module_id, dst_module_id);
    ...
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_ENB_CONFIG_UPDATE, msg_length,cell_index);

    /* Fill S1AP_OAM_ENB_CONFIG_UPDATE message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_enb_config_update(&p_s1apOam_msg, p_s1ap_oam_enb_config_update))
    {
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_plmn_identity != PNULL);
    /* Get length of OCTET_STRING FIXED of basic type elements */
...
)
{
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_plmn_identity->plmn_id[loop], "plmn_id[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_bc_plmn_list != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_bc_plmn_list->num_bplmn, "num_bplmn");
    *pp_buffer += sizeof(p_bc_plmn_list->num_bplmn);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_bc_plmn_list->num_bplmn; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_s1ap_plmn_identity(pp_buffer, &p_bc_plmn_list->plmn_identity[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_supp_ta != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_supp_ta->bitmask, "bitmask");
    *pp_buffer += sizeof(p_supp_ta->bitmask);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_supp_ta->tac[loop], "tac[]");
            *pp_buffer += sizeof(UInt8);
        }
    }

    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_bc_plmn_list(pp_buffer, &p_supp_ta->bc_plmn_list))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_supp_ta_list != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_supp_ta_list->num_supported_tais, "num_supported_tais");
    *pp_buffer += sizeof(p_supp_ta_list->num_supported_tais);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_supp_ta_list->num_supported_tais; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_supp_ta(pp_buffer, &p_supp_ta_list->supp_tais[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_csg_id_info != PNULL);
    /* Get length of OCTET_STRING FIXED of basic type elements */
...
)
{
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_csg_id_info->csg_id[loop], "csg_id[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_csg_id_list != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_csg_id_list->num_csg_ids, "num_csg_ids");
    *pp_buffer += sizeof(p_csg_id_list->num_csg_ids);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_csg_id_list->num_csg_ids; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_csg_id_info(pp_buffer, &p_csg_id_list->csg_ids[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_mme_id_list_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_id_list_info->num_mme_id, "num_mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_mme_id_list_info->num_mme_id);
    ...
    /* Compose OCTET_STRING VARIABLE of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_id_list_info->mme_id[loop], "mme_id[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_mme_conn_status_response != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_conn_status_response->mme_count, "mme_count");
    *pp_buffer += sizeof(p_s1ap_oam_mme_conn_status_response->mme_count);
    ...
    /* Compose OCTET_STRING FIXED of IEs */
    {
        ...
        for (loop = 0; loop < ARRSIZE(p_s1ap_oam_mme_conn_status_response->oam_mme_conn_info_list); loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_conn_info(pp_buffer, &p_s1ap_oam_mme_conn_status_response->oam_mme_conn_info_list[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_mme_conn_status_response
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_MME_CONN_INFO_RESPONSE", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_MME_CONN_INFO_RESPONSE, msg_length,cell_index);

    /* Fill S1AP_OAM_MME_CONN_INFO_RESPONSE message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_conn_status_response(&p_s1apOam_msg, p_s1ap_oam_mme_conn_status_response))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_mme_conn_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_conn_info->mme_id, "mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_mme_conn_info->mme_id);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_conn_info->response, "response");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_enb_config_update_response != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_enb_config_update_response->mme_id, "mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_enb_config_update_response->mme_id);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_enb_config_update_response->response, "response");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_enb_config_update_response
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_ENB_CONFIG_UPDATE_RESPONSE", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_ENB_CONFIG_UPDATE_RESPONSE, msg_length,cell_index);

    /* Fill S1AP_OAM_ENB_CONFIG_UPDATE_RESPONSE message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_enb_config_update_response(&p_s1apOam_msg, p_s1ap_oam_enb_config_update_response))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_close_mme_conn != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_close_mme_conn->mme_count, "mme_count");
    *pp_buffer += sizeof(p_s1ap_oam_close_mme_conn->mme_count);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_close_mme_conn->mme_id[loop], "mme_id[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_close_mme_conn
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_CLOSE_MME_CONN", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_CLOSE_MME_CONN, msg_length,cell_index);

    /* Fill S1AP_OAM_CLOSE_MME_CONN message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_close_mme_conn(&p_s1apOam_msg, p_s1ap_oam_close_mme_conn))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_reestab_mme_conn != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_reestab_mme_conn->mme_count, "mme_count");
    *pp_buffer += sizeof(p_s1ap_oam_reestab_mme_conn->mme_count);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_reestab_mme_conn->mme_id[loop], "mme_id[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_reestab_mme_conn
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_REESTAB_MME_CONN", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_REESTAB_MME_CONN, msg_length,cell_index);

    /* Fill S1AP_OAM_REESTAB_MME_CONN message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_reestab_mme_conn(&p_s1apOam_msg, p_s1ap_oam_reestab_mme_conn))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_provision_req != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1apInfo(pp_buffer, &p_s1ap_oam_provision_req->s1apInfo))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_provision_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_PROVISION_REQ", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_PROVISION_REQ, msg_length,cell_index);

    /* Fill S1AP_OAM_PROVISION_REQ message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_provision_req(&p_s1apOam_msg, p_s1ap_oam_provision_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    *pp_buffer += sizeof(p_mme_comm_info->num_ip_addr);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_mme_comm_info->num_ip_addr; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_ip_addr(pp_buffer, &p_mme_comm_info->ip_addr[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    *pp_buffer += sizeof(p_mme_comm_info->num_ipv6_addr);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_mme_comm_info->num_ipv6_addr; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_ipv6_addr(pp_buffer, &p_mme_comm_info->ipv6_addr[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_enb_comm_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_enb_comm_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_enb_comm_info->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_enb_comm_info->num_ip_addr, "num_ip_addr");
    *pp_buffer += sizeof(p_enb_comm_info->num_ip_addr);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_enb_comm_info->num_ip_addr; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_ip_addr(pp_buffer, &p_enb_comm_info->ip_addr[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_enb_comm_info->port, "port");
    *pp_buffer += sizeof(p_enb_comm_info->port);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_enb_comm_info->num_ipv6_addr, "num_ipv6_addr");
    *pp_buffer += sizeof(p_enb_comm_info->num_ipv6_addr);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_enb_comm_info->num_ipv6_addr; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_ipv6_addr(pp_buffer, &p_enb_comm_info->ipv6_addr[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_enb_id_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_enb_id_info->presence_bitmask, "presence_bitmask");
    *pp_buffer += sizeof(p_enb_id_info->presence_bitmask);
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_macro_enb_id(pp_buffer, &p_enb_id_info->macro_enb_id))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_home_enb_id(pp_buffer, &p_enb_id_info->home_enb_id))
    {
        return OAM_FAILURE;
    }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_gb_enb_id != PNULL);
...
)
{
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_plmn_identity(pp_buffer, &p_gb_enb_id->plmn_identity))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_enb_id_info(pp_buffer, &p_gb_enb_id->enb_id))
    {
        return OAM_FAILURE;
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_s1_setup_req != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1_setup_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1_setup_req->bitmask);

    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_gb_enb_id(pp_buffer, &p_s1_setup_req->gb_enb_id))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1_setup_req->enb_name[loop], "enb_name[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_supp_ta_list(pp_buffer, &p_s1_setup_req->supp_ta_list))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_csg_id_list(pp_buffer, &p_s1_setup_req->csg_id_list))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1_setup_req->default_paging_drx, "default_paging_drx");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_sctp_conf_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_sctp_conf_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->bitmask);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_sctp_conf_info->init_max_attempts, "init_max_attempts");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->init_max_attempts);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_sctp_conf_info->rto_initial, "rto_initial");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->rto_initial);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_sctp_conf_info->rto_max, "rto_max");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->rto_max);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_sctp_conf_info->rto_min, "rto_min");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->rto_min);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_sctp_conf_info->assoc_max_retrans, "assoc_max_retrans");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->assoc_max_retrans);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_sctp_conf_info->valid_cookie_life, "valid_cookie_life");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->valid_cookie_life);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_sctp_conf_info->path_max_retrans, "path_max_retrans");
    *pp_buffer += sizeof(p_s1ap_sctp_conf_info->path_max_retrans);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_sctp_conf_info->s1ap_dscp_value, "s1ap_dscp_value");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1apInfo != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1apInfo->num_mme, "num_mme");
    *pp_buffer += sizeof(p_s1apInfo->num_mme);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_s1apInfo->num_mme; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_mme_comm_info(pp_buffer, &p_s1apInfo->mme_comm_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_enb_comm_info(pp_buffer, &p_s1apInfo->enb_comm_info))
    {
        return OAM_FAILURE;
    }

    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1_setup_req(pp_buffer, &p_s1apInfo->s1_setup_req_parameters))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1apInfo->s1_config_timer, "s1_config_timer");
    *pp_buffer += sizeof(p_s1apInfo->s1_config_timer);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1apInfo->reset_ep_timer, "reset_ep_timer");
    *pp_buffer += sizeof(p_s1apInfo->reset_ep_timer);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1apInfo->max_s1_config_retries, "max_s1_config_retries");
    *pp_buffer += sizeof(p_s1apInfo->max_s1_config_retries);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1apInfo->max_reset_retries, "max_reset_retries");
    *pp_buffer += sizeof(p_s1apInfo->max_reset_retries);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1apInfo->s1ap_pws_timer, "s1ap_pws_timer");
    *pp_buffer += sizeof(p_s1apInfo->s1ap_pws_timer);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1apInfo->s1ap_kill_timer, "s1ap_kill_timer");
    *pp_buffer += sizeof(p_s1apInfo->s1ap_kill_timer);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1apInfo->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1apInfo->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1apInfo->mme_selection_algo, "mme_selection_algo");
    *pp_buffer += sizeof(p_s1apInfo->mme_selection_algo);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1apInfo->s1_conn_recovery_duration, "s1_conn_recovery_duration");
    *pp_buffer += sizeof(p_s1apInfo->s1_conn_recovery_duration);
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_sctp_conf_info(pp_buffer, &p_s1apInfo->s1ap_sctp_conf_param))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1apInfo->s1ap_health_mon_time_int, "s1ap_health_mon_time_int");
    *pp_buffer += sizeof(p_s1apInfo->s1ap_health_mon_time_int);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1apInfo->log_level, "log_level");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_provision_resp != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_provision_resp->response, "response");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_provision_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_PROVISION_RESP", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_PROVISION_RESP, msg_length,cell_index);

    /* Fill S1AP_OAM_PROVISION_RESP message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_provision_resp(&p_s1apOam_msg, p_s1ap_oam_provision_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_get_log_level_resp != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_get_log_level_resp->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_oam_get_log_level_resp->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_get_log_level_resp->log_on_off, "log_on_off");
    *pp_buffer += sizeof(p_s1ap_oam_get_log_level_resp->log_on_off);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_get_log_level_resp->log_level, "log_level");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_get_log_level_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_GET_LOG_LEVEL_RESP", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_GET_LOG_LEVEL_RESP, msg_length,cell_index);

    /* Fill S1AP_OAM_GET_LOG_LEVEL_RESP message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_get_log_level_resp(&p_s1apOam_msg, p_s1ap_oam_get_log_level_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_set_log_level_req != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_set_log_level_req->log_level, "log_level");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_set_log_level_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_SET_LOG_LEVEL_REQ", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_SET_LOG_LEVEL_REQ, msg_length,cell_index);

    /* Fill S1AP_OAM_SET_LOG_LEVEL_REQ message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_set_log_level_req(&p_s1apOam_msg, p_s1ap_oam_set_log_level_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_set_log_level_resp != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_set_log_level_resp->response, "response");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_set_log_level_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_SET_LOG_LEVEL_RESP", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_SET_LOG_LEVEL_RESP, msg_length,cell_index);

    /* Fill S1AP_OAM_SET_LOG_LEVEL_RESP message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_set_log_level_resp(&p_s1apOam_msg, p_s1ap_oam_set_log_level_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_log_enable_req != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_log_enable_req->log_on_off, "log_on_off");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_log_enable_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_LOG_ENABLE_REQ", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_LOG_ENABLE_REQ, msg_length,cell_index);

    /* Fill S1AP_OAM_LOG_ENABLE_REQ message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_log_enable_req(&p_s1apOam_msg, p_s1ap_oam_log_enable_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_log_enable_resp != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_log_enable_resp->response, "response");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_log_enable_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_LOG_ENABLE_RESP", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_LOG_ENABLE_RESP, msg_length,cell_index);

    /* Fill S1AP_OAM_LOG_ENABLE_RESP message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_log_enable_resp(&p_s1apOam_msg, p_s1ap_oam_log_enable_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_reset_resp != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_reset_resp->response, "response");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_reset_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_RESET_RESP", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_RESET_RESP, msg_length,cell_index);

    /* Fill S1AP_OAM_RESET_RESP message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_reset_resp(&p_s1apOam_msg, p_s1ap_oam_reset_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_s1ap_link_status_ind != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_s1ap_link_status_ind->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_oam_s1ap_link_status_ind->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_s1ap_link_status_ind->mme_id, "mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_s1ap_link_status_ind->mme_id);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_s1ap_link_status_ind->status, "status");
    *pp_buffer += sizeof(p_s1ap_oam_s1ap_link_status_ind->status);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_s1ap_link_status_ind->ip_addr[loop], "ip_addr[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
    }
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_s1ap_link_status_ind->ipv6_addr[loop], "ipv6_addr[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_s1ap_link_status_ind->port, "port");
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_s1ap_link_status_ind
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_S1AP_LINK_STATUS_IND", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_S1AP_LINK_STATUS_IND, msg_length,cell_index);

    /* Fill S1AP_OAM_S1AP_LINK_STATUS_IND message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_s1ap_link_status_ind(&p_s1apOam_msg, p_s1ap_oam_s1ap_link_status_ind))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_status_resp != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_status_resp->active_mme_count, "active_mme_count");
    *pp_buffer += sizeof(p_s1ap_oam_status_resp->active_mme_count);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_s1ap_oam_status_resp->active_mme_count; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_active_mme_ctx(pp_buffer, &p_s1ap_oam_status_resp->active_mme_list[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_status_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_STATUS_RESP", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_STATUS_RESP, msg_length,cell_index);

    /* Fill S1AP_OAM_STATUS_RESP message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_status_resp(&p_s1apOam_msg, p_s1ap_oam_status_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_active_mme_ctx != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_active_mme_ctx->mme_id, "mme_id");
    *pp_buffer += sizeof(p_active_mme_ctx->mme_id);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_active_mme_ctx->count_of_ue, "count_of_ue");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_mme_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_mme_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_oam_mme_info->bitmask);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_info->mme_id, "mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_mme_info->mme_id);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_info->ip_addr[loop], "ip_addr[]");
            *pp_buffer += sizeof(UInt8);
        }
    }

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_mme_info->port, "port");
    *pp_buffer += sizeof(p_s1ap_oam_mme_info->port);

    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_mme_info(pp_buffer, &p_s1ap_oam_mme_info->mme_info))
    {
        return OAM_FAILURE;
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_mme_info
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_MME_INFO", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_MME_INFO, msg_length,cell_index);

    /* Fill S1AP_OAM_MME_INFO message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_info(&p_s1apOam_msg, p_s1ap_oam_mme_info))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_served_group_id != PNULL);
    /* Get length of OCTET_STRING FIXED of basic type elements */
...
)
{
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_served_group_id->mmegi[loop], "mmegi[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_served_mmec != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_served_mmec->mmec, "mmec");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_served_gummei_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_served_gummei_info->num_served_plmns, "num_served_plmns");
    *pp_buffer += sizeof(p_s1ap_served_gummei_info->num_served_plmns);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_s1ap_served_gummei_info->num_served_plmns; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_s1ap_plmn_identity(pp_buffer, &p_s1ap_served_gummei_info->plmn_identity[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_served_gummei_info->num_served_group_ids, "num_served_group_ids");
    *pp_buffer += sizeof(p_s1ap_served_gummei_info->num_served_group_ids);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_s1ap_served_gummei_info->num_served_group_ids; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_s1ap_served_group_id(pp_buffer, &p_s1ap_served_gummei_info->served_group_id[loop]))
            {
                return OAM_FAILURE;
            }
        }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_served_gummei_info->num_served_mmecs, "num_served_mmecs");
    *pp_buffer += sizeof(p_s1ap_served_gummei_info->num_served_mmecs);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_s1ap_served_gummei_info->num_served_mmecs; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_s1ap_served_mmec(pp_buffer, &p_s1ap_served_gummei_info->served_mmec[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_mme_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_mme_info->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_mme_info->bitmask);
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_mme_info->mme_name[loop], "mme_name[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_served_gummei_info(pp_buffer, &p_s1ap_mme_info->served_gummei_info))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_mme_info->relative_mme_capacity, "relative_mme_capacity");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_get_sctp_status_req != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_get_sctp_status_req->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_oam_get_sctp_status_req->bitmask);
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_id_list_info(pp_buffer, &p_s1ap_oam_get_sctp_status_req->s1ap_oam_mme_status_list))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_get_sctp_status_req
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_GET_SCTP_STATUS_REQ", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_GET_SCTP_STATUS_REQ, msg_length,cell_index);

    /* Fill S1AP_OAM_GET_SCTP_STATUS_REQ message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_get_sctp_status_req(&p_s1apOam_msg, p_s1ap_oam_get_sctp_status_req))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_get_sctp_status_resp != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT16(*pp_buffer, &p_s1ap_oam_get_sctp_status_resp->bitmask, "bitmask");
    *pp_buffer += sizeof(p_s1ap_oam_get_sctp_status_resp->bitmask);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_get_sctp_status_resp->response, "response");
    *pp_buffer += sizeof(p_s1ap_oam_get_sctp_status_resp->response);
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_status_params_list_info(pp_buffer, &p_s1ap_oam_get_sctp_status_resp->s1ap_oam_mme_status_params_list))
    {
        return OAM_FAILURE;
    }
    }
    ...
    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_failed_list(pp_buffer, &p_s1ap_oam_get_sctp_status_resp->mme_failed_list))
    {
        return OAM_FAILURE;
    }
    }
...
/******************************************************************************
*   FUNCTION NAME: oam_s1ap_il_send_s1ap_oam_get_sctp_status_resp
*
*   DESCRIPTION:
...
)
{
    ...
    OAM_LOG(OAM,OAM_INFO, "Src(%u)->Dst(%u):S1AP_OAM_GET_SCTP_STATUS_RESP", src_module_id, dst_module_id);
    ...
    p_s1apOam_msg = p_s1apOam_msg + OAM_CSPL_HDR_SIZE;
    oam_construct_interface_api_header(p_s1apOam_msg, transaction_id, src_module_id,
        RRC_MODULE_ID, S1AP_OAM_GET_SCTP_STATUS_RESP, msg_length,cell_index);

    /* Fill S1AP_OAM_GET_SCTP_STATUS_RESP message */
    p_s1apOam_msg = p_s1apOam_msg + LOWER_LAYER_INTERFACE_HEADER_SIZE;
    if (OAM_FAILURE == rrc_il_compose_s1ap_oam_get_sctp_status_resp(&p_s1apOam_msg, p_s1ap_oam_get_sctp_status_resp))
    {
        oam_mem_free(p_msg,&oam_error);
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_mme_id_status_params != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_id_status_params->mme_id, "mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_mme_id_status_params->mme_id);
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_oam_mme_id_status_params->status, "status");
    *pp_buffer += sizeof(p_s1ap_oam_mme_id_status_params->status);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_oam_mme_id_status_params->in_streams, "in_streams");
    *pp_buffer += sizeof(p_s1ap_oam_mme_id_status_params->in_streams);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_oam_mme_id_status_params->out_streams, "out_streams");
    *pp_buffer += sizeof(p_s1ap_oam_mme_id_status_params->out_streams);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT32(*pp_buffer, &p_s1ap_oam_mme_id_status_params->local_port, "local_port");
    *pp_buffer += sizeof(p_s1ap_oam_mme_id_status_params->local_port);

    /* Compose IE */
    if (OAM_FAILURE == rrc_il_compose_rrc_timeval(pp_buffer, &p_s1ap_oam_mme_id_status_params->start_time))
    {
        return OAM_FAILURE;
    }
    ...
    /* Compose OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_id_status_params->primary_peer_addr[loop], "primary_peer_addr[]");
            *pp_buffer += sizeof(UInt8);
        }
    }
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_mme_status_params_list_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_status_params_list_info->num_mme_id, "num_mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_mme_status_params_list_info->num_mme_id);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_s1ap_oam_mme_status_params_list_info->num_mme_id; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_s1ap_oam_mme_id_status_params(pp_buffer, &p_s1ap_oam_mme_status_params_list_info->staus_params[loop]))
            {
                return OAM_FAILURE;
            }
        }
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_failed_mme_info != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_failed_mme_info->mme_id, "mme_id");
    *pp_buffer += sizeof(p_s1ap_oam_failed_mme_info->mme_id);

    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_failed_mme_info->cause, "cause");
...
)
{
    ...
    OAM_NULL_CHECK(p_s1ap_oam_mme_failed_list != PNULL);
    /* Get length of parameter of basic type */
...
)
{
    ...
    /* Compose parameter of basic type */
    OAM_CP_PACK_UINT8(*pp_buffer, &p_s1ap_oam_mme_failed_list->count, "count");
    *pp_buffer += sizeof(p_s1ap_oam_mme_failed_list->count);
    ...
    /* Compose OCTET_STRING VARIABLE of IEs */
    {
        ...
        for (loop = 0; loop < p_s1ap_oam_mme_failed_list->count; loop++)
        {
            if (OAM_FAILURE == rrc_il_compose_s1ap_oam_failed_mme_info(pp_buffer, &p_s1ap_oam_mme_failed_list->failed_mme_info[loop]))
            {
                return OAM_FAILURE;
            }
        }
