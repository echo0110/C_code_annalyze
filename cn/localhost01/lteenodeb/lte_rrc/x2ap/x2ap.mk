...
INC += -I/home/zhanghh/sysroot/sysroot-glibc-linaro-2.25-2019.02-aarch64-linux-gnu/usr/include
endif
#MENB_CHANGES_START  
...
X2AP_CFLAGS += -DCRAN_RLC_PDCP_SPLIT
endif
...
INC += -I${X2AP_DIR}/../tools/advlogger/src/
    ...
    X2AP_DEFINES += -DLINUX_PC_TEST
	X2AP_CFLAGS	 += -fprofile-arcs -ftest-coverage
    endif
...
COMPILER = $(LTE_CC) $(X2AP_DEFINES) $(X2AP_CFLAGS) $(INC) -o $@ -c  $^
