...
static
rrc_return_et
rrc_il_parse_x2ap_sctp_conf_info
(
...
static
rrc_return_et
rrc_il_parse_x2ap_con_tim_info
(
...
static
rrc_return_et
rrc_il_parse_x2apOam_srvd_cells
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_enb_id_list_info
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_gnb_id_list_info
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_enb_id_status_params
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_enb_status_params_list_info
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_failed_gb_enb_info
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_enb_failed_list
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_gnb_id_status_params
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_gnb_status_params_list_info
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_failed_gb_gnb_info
(
...
static
rrc_return_et
rrc_il_parse_x2ap_oam_gb_gnb_failed_list
(
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_provision_req, 0, sizeof(x2ap_oam_provision_req_t));
    ...
    rrc_cp_unpack_U16(&p_x2ap_oam_provision_req->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U16);

    if (p_x2ap_oam_provision_req->bitmask & RRC_X2AP_PROVISION_INFO_PRESENT)
    {

    if (RRC_FAILURE == rrc_il_parse_x2ap_info(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_son_comm_info(
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_sctp_conf_info, 0, sizeof(x2ap_sctp_conf_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_sctp_conf_info->hbinterval, p_src + *p_length_read, "hbinterval");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_sctp_conf_info->pathmaxrxt, p_src + *p_length_read, "pathmaxrxt");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_sctp_conf_info->init_num_ostreams, p_src + *p_length_read, "init_num_ostreams");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_sctp_conf_info->init_max_instreams, p_src + *p_length_read, "init_max_instreams");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_sctp_conf_info->init_max_attempts, p_src + *p_length_read, "init_max_attempts");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_sctp_conf_info->init_max_init_timeo, p_src + *p_length_read, "init_max_init_timeo");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_sctp_conf_info->rto_initial, p_src + *p_length_read, "rto_initial");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_sctp_conf_info->rto_max, p_src + *p_length_read, "rto_max");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_sctp_conf_info->rto_min, p_src + *p_length_read, "rto_min");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_sctp_conf_info->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_sctp_conf_info->assoc_max_retrans, p_src + *p_length_read, "assoc_max_retrans");
    *p_length_read += sizeof(U16);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_sctp_conf_info->valid_cookie_life, p_src + *p_length_read, "valid_cookie_life");
    *p_length_read += sizeof(U32);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_sctp_conf_info->x2ap_dscp_value, p_src + *p_length_read, "x2ap_dscp_value");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_con_tim_info, 0, sizeof(x2ap_con_tim_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_con_tim_info->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->sctp_connect_tim_val, p_src + *p_length_read, "sctp_connect_tim_val");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_csi_guard_tim_val, p_src + *p_length_read, "x2ap_csi_guard_tim_val");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_con_tim_info->x2ap_time_to_wait_index, p_src + *p_length_read, "x2ap_time_to_wait_index");
    *p_length_read += sizeof(U8);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_setup_retry_tim_val, p_src + *p_length_read, "x2ap_setup_retry_tim_val");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_con_tim_info->sctp_connect_retry_cnt, p_src + *p_length_read, "sctp_connect_retry_cnt");
    *p_length_read += sizeof(U8);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_con_tim_info->x2ap_setup_retry_cnt, p_src + *p_length_read, "x2ap_setup_retry_cnt");
    *p_length_read += sizeof(U8);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_con_tim_info->eNB_Config_Update_retry_cnt, p_src + *p_length_read, "eNB_Config_Update_retry_cnt");
    *p_length_read += sizeof(U8);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->eNB_Config_Update_retry_timer_val, p_src + *p_length_read, "eNB_Config_Update_retry_timer_val");
    *p_length_read += sizeof(U32);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_con_tim_info->eNB_Config_Update_time_to_wait_retry_cnt, p_src + *p_length_read, "eNB_Config_Update_time_to_wait_retry_cnt");
    *p_length_read += sizeof(U8);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->eNB_Config_Update_time_to_wait_offset, p_src + *p_length_read, "eNB_Config_Update_time_to_wait_offset");
    *p_length_read += sizeof(U32);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_con_tim_info->x2ap_enb_reset_retry_cnt, p_src + *p_length_read, "x2ap_enb_reset_retry_cnt");
    *p_length_read += sizeof(U8);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_enb_reset_guard_tim_val, p_src + *p_length_read, "x2ap_enb_reset_guard_tim_val");
    *p_length_read += sizeof(U32);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_rsu_enb_guard_tim_val, p_src + *p_length_read, "x2ap_rsu_enb_guard_tim_val");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_rsu_rrm_guard_tim_val, p_src + *p_length_read, "x2ap_rsu_rrm_guard_tim_val");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_cell_activation_retry_cnt, p_src + *p_length_read, "x2ap_cell_activation_retry_cnt");
    *p_length_read += sizeof(U32);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_cell_activation_guard_tim_val, p_src + *p_length_read, "x2ap_cell_activation_guard_tim_val");
    *p_length_read += sizeof(U32);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_con_tim_info->x2ap_mobility_setting_change_retry_cnt, p_src + *p_length_read, "x2ap_mobility_setting_change_retry_cnt");
    *p_length_read += sizeof(U8);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_con_tim_info->x2ap_mobility_setting_change_guard_tim_val, p_src + *p_length_read, "x2ap_mobility_setting_change_guard_tim_val");
    *p_length_read += sizeof(U32);
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_con_tim_info->x2ap_health_mon_time_int, p_src + *p_length_read, "x2ap_health_mon_time_int");
    *p_length_read += sizeof(U16);
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_conf_param, 0, sizeof(x2ap_conf_param_t));

    /* This function parses x2ap_conf_param */

    if (RRC_FAILURE == rrc_il_parse_x2ap_sctp_conf_info(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_con_tim_info(
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2apOam_srvd_cells, 0, sizeof(x2apOam_srvd_cells_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2apOam_srvd_cells->num_srvd_cell, p_src + *p_length_read, "num_srvd_cell");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_gu_grp_ids, 0, sizeof(x2ap_gu_grp_ids_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_gu_grp_ids->num_gu_group_id, p_src + *p_length_read, "num_gu_group_id");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_info, 0, sizeof(x2ap_info_t));
    ...
    *p_length_read += length_read;
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_info->num_peer_enb, p_src + *p_length_read, "num_peer_enb");
    *p_length_read += sizeof(U8);
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_conf_param(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_x2apOam_srvd_cells(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_gu_grp_ids(
    ...
    *p_length_read += length_read;
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_info->log_level, p_src + *p_length_read, "log_level");
    *p_length_read += sizeof(U8);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_info->num_peer_gnb, p_src + *p_length_read, "num_peer_gnb");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_son_comm_info, 0, sizeof(son_comm_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_son_comm_info->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U16);

    if (*p_length_read + (S32)sizeof(p_son_comm_info->ip_addr) > length_left)
    {
        RRC_TRACE(RRC_WARNING, "Incoming message damaged!");
        return RRC_FAILURE;
    }
    ...
    /* Parse OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            rrc_cp_unpack_U8((void*)&p_son_comm_info->ip_addr[loop], (void*)(p_src + *p_length_read), "ip_addr[]");
            *p_length_read += sizeof(U8);
        }
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_son_comm_info->port, p_src + *p_length_read, "port");
    *p_length_read += sizeof(U16);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_provision_resp, 0, sizeof(x2ap_oam_provision_resp_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_provision_resp->response, p_src + *p_length_read, "response");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_get_log_level_resp, 0, sizeof(x2ap_oam_get_log_level_resp_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_oam_get_log_level_resp->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_get_log_level_resp->log_on_off, p_src + *p_length_read, "log_on_off");
    *p_length_read += sizeof(U8);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_get_log_level_resp->log_level, p_src + *p_length_read, "log_level");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_set_log_level_req, 0, sizeof(x2ap_oam_set_log_level_req_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_set_log_level_req->log_level, p_src + *p_length_read, "log_level");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_set_log_level_resp, 0, sizeof(x2ap_oam_set_log_level_resp_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_set_log_level_resp->response, p_src + *p_length_read, "response");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_log_enable_req, 0, sizeof(x2ap_oam_log_enable_req_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_log_enable_req->log_on_off, p_src + *p_length_read, "log_on_off");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_log_enable_resp, 0, sizeof(x2ap_oam_log_enable_resp_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_log_enable_resp->response, p_src + *p_length_read, "response");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_x2_link_down, 0, sizeof(x2ap_oam_x2_link_down_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_x2_link_down->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U8);
    ...
    *p_length_read += length_read;
    ...
    if (*p_length_read + (S32)sizeof(p_x2ap_oam_x2_link_down->ip_addr) > length_left)
    {
        RRC_TRACE(RRC_WARNING, "Incoming message damaged!");
        return RRC_FAILURE;
    }
    ...
    /* Parse OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            rrc_cp_unpack_U8((void*)&p_x2ap_oam_x2_link_down->ip_addr[loop], (void*)(p_src + *p_length_read), "ip_addr[]");
            *p_length_read += sizeof(U8);
        }
    }
    }
    ...
    if (*p_length_read + (S32)sizeof(p_x2ap_oam_x2_link_down->ipv6_addr) > length_left)
    {
        RRC_TRACE(RRC_WARNING, "Incoming message damaged!");
        return RRC_FAILURE;
    }
    ...
    /* Parse OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            rrc_cp_unpack_U8((void*)&p_x2ap_oam_x2_link_down->ipv6_addr[loop], (void*)(p_src + *p_length_read), "ipv6_addr[]");
            *p_length_read += sizeof(U8);
        }
    }
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_oam_x2_link_down->port, p_src + *p_length_read, "port");
    *p_length_read += sizeof(U16);
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_x2_link_up, 0, sizeof(x2ap_oam_x2_link_up_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_x2_link_up->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U8);
    ...
    *p_length_read += length_read;
    ...
    if (*p_length_read + (S32)sizeof(p_x2ap_oam_x2_link_up->ip_addr) > length_left)
    {
        RRC_TRACE(RRC_WARNING, "Incoming message damaged!");
        return RRC_FAILURE;
    }
    ...
    /* Parse OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            rrc_cp_unpack_U8((void*)&p_x2ap_oam_x2_link_up->ip_addr[loop], (void*)(p_src + *p_length_read), "ip_addr[]");
            *p_length_read += sizeof(U8);
        }
    }
    }
    ...
    if (*p_length_read + (S32)sizeof(p_x2ap_oam_x2_link_up->ipv6_addr) > length_left)
    {
        RRC_TRACE(RRC_WARNING, "Incoming message damaged!");
        return RRC_FAILURE;
    }
    ...
    /* Parse OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            rrc_cp_unpack_U8((void*)&p_x2ap_oam_x2_link_up->ipv6_addr[loop], (void*)(p_src + *p_length_read), "ipv6_addr[]");
            *p_length_read += sizeof(U8);
        }
    }
    }
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_oam_x2_link_up->port, p_src + *p_length_read, "port");
    *p_length_read += sizeof(U16);
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_x2_link_setup_req, 0, sizeof(x2ap_oam_x2_link_setup_req_t));
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_x2_link_setup_resp, 0, sizeof(x2ap_oam_x2_link_setup_resp_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_x2_link_setup_resp->response, p_src + *p_length_read, "response");
    *p_length_read += sizeof(U8);
...
)
{
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_cleanup_resp, 0, sizeof(x2ap_oam_cleanup_resp_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_cleanup_resp->response, p_src + *p_length_read, "response");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_get_sctp_status_req, 0, sizeof(x2ap_oam_get_sctp_status_req_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_oam_get_sctp_status_req->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U16);

    if (p_x2ap_oam_get_sctp_status_req->bitmask & X2AP_OAM_GLOBAL_ENB_STATUS_LIST_PRESENT)
    {

    if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_enb_id_list_info(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_gnb_id_list_info(
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_enb_id_list_info, 0, sizeof(x2ap_oam_gb_enb_id_list_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_gb_enb_id_list_info->num_peer_enb, p_src + *p_length_read, "num_peer_enb");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_gnb_id_list_info, 0, sizeof(x2ap_oam_gb_gnb_id_list_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_gb_gnb_id_list_info->num_peer_gnb, p_src + *p_length_read, "num_peer_gnb");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_get_sctp_status_resp, 0, sizeof(x2ap_oam_get_sctp_status_resp_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U16(&p_x2ap_oam_get_sctp_status_resp->bitmask, p_src + *p_length_read, "bitmask");
    *p_length_read += sizeof(U16);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_get_sctp_status_resp->response, p_src + *p_length_read, "response");
    *p_length_read += sizeof(U8);
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_enb_status_params_list_info(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_enb_failed_list(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_gnb_status_params_list_info(
    ...
    *p_length_read += length_read;
    ...
    if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_gnb_failed_list(
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_enb_id_status_params, 0, sizeof(x2ap_oam_gb_enb_id_status_params_t));
    ...
    *p_length_read += length_read;
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_enb_id_status_params->status, p_src + *p_length_read, "status");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_enb_id_status_params->in_streams, p_src + *p_length_read, "in_streams");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_enb_id_status_params->out_streams, p_src + *p_length_read, "out_streams");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_enb_id_status_params->local_port, p_src + *p_length_read, "local_port");
    *p_length_read += sizeof(U32);
    ...
    *p_length_read += length_read;
    ...
    if (*p_length_read + (S32)sizeof(p_x2ap_oam_gb_enb_id_status_params->primary_peer_addr) > length_left)
    {
        RRC_TRACE(RRC_WARNING, "Incoming message damaged!");
        return RRC_FAILURE;
    }
    ...
    /* Parse OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            rrc_cp_unpack_U8((void*)&p_x2ap_oam_gb_enb_id_status_params->primary_peer_addr[loop], (void*)(p_src + *p_length_read), "primary_peer_addr[]");
            *p_length_read += sizeof(U8);
        }
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_enb_status_params_list_info, 0, sizeof(x2ap_oam_gb_enb_status_params_list_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_gb_enb_status_params_list_info->num_peer_enb, p_src + *p_length_read, "num_peer_enb");
    *p_length_read += sizeof(U8);
    ...
    /* Parse OCTET_STRING VARIABLE of IEs */
    {
        ...
        {
            if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_enb_id_status_params(
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_failed_gb_enb_info, 0, sizeof(x2ap_oam_failed_gb_enb_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_failed_gb_enb_info->cause, p_src + *p_length_read, "cause");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_enb_failed_list, 0, sizeof(x2ap_oam_gb_enb_failed_list_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_gb_enb_failed_list->count, p_src + *p_length_read, "count");
    *p_length_read += sizeof(U8);
    ...
    /* Parse OCTET_STRING VARIABLE of IEs */
    {
        ...
        {
            if (RRC_FAILURE == rrc_il_parse_x2ap_oam_failed_gb_enb_info(
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_gnb_id_status_params, 0, sizeof(x2ap_oam_gb_gnb_id_status_params_t));
    ...
    *p_length_read += length_read;
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_gnb_id_status_params->status, p_src + *p_length_read, "status");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_gnb_id_status_params->in_streams, p_src + *p_length_read, "in_streams");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_gnb_id_status_params->out_streams, p_src + *p_length_read, "out_streams");
    *p_length_read += sizeof(U32);
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U32(&p_x2ap_oam_gb_gnb_id_status_params->local_port, p_src + *p_length_read, "local_port");
    *p_length_read += sizeof(U32);
    ...
    *p_length_read += length_read;
    ...
    if (*p_length_read + (S32)sizeof(p_x2ap_oam_gb_gnb_id_status_params->primary_peer_addr) > length_left)
    {
        RRC_TRACE(RRC_WARNING, "Incoming message damaged!");
        return RRC_FAILURE;
    }
    ...
    /* Parse OCTET_STRING FIXED of basic type elements */
    {
        ...
        {
            rrc_cp_unpack_U8((void*)&p_x2ap_oam_gb_gnb_id_status_params->primary_peer_addr[loop], (void*)(p_src + *p_length_read), "primary_peer_addr[]");
            *p_length_read += sizeof(U8);
        }
    }
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_gnb_status_params_list_info, 0, sizeof(x2ap_oam_gb_gnb_status_params_list_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_gb_gnb_status_params_list_info->num_peer_gnb, p_src + *p_length_read, "num_peer_gnb");
    *p_length_read += sizeof(U8);
    ...
    /* Parse OCTET_STRING VARIABLE of IEs */
    {
        ...
        {
            if (RRC_FAILURE == rrc_il_parse_x2ap_oam_gb_gnb_id_status_params(
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_failed_gb_gnb_info, 0, sizeof(x2ap_oam_failed_gb_gnb_info_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_failed_gb_gnb_info->cause, p_src + *p_length_read, "cause");
    *p_length_read += sizeof(U8);
...
)
{
    ...
    *p_length_read = 0;
    ...
    memset_wrapper(p_x2ap_oam_gb_gnb_failed_list, 0, sizeof(x2ap_oam_gb_gnb_failed_list_t));
    ...
    /* Parse/Unpack parameter of basic type */
    rrc_cp_unpack_U8(&p_x2ap_oam_gb_gnb_failed_list->count, p_src + *p_length_read, "count");
    *p_length_read += sizeof(U8);
    ...
    /* Parse OCTET_STRING VARIABLE of IEs */
    {
        ...
        {
            if (RRC_FAILURE == rrc_il_parse_x2ap_oam_failed_gb_gnb_info(
