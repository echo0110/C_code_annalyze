...
# The build Mode
#MODE:=release	#MODE already defined in lterunner.mk
...
RRC_DEFINES_debug += -DLINUX_PC_TEST 
endif

RRC_DEFINES_profiler+=	-DRRC_ENABLE_TRACE \
			  			-URRC_DEBUG  -UHEADER_ALIGNMENT -DRRC_PROFILER -ULOCKLESS_IMPL
...
RRC_COMMON_INCLUDES += -I/home/zhanghh/sysroot/sysroot-glibc-linaro-2.25-2019.02-aarch64-linux-gnu/usr/include
endif
RRC_DEFINES_release+=
