...
/* SPR 20908 Start */
#define RRC_OAM_MAX_UPPER_MODULES               3 
/* SPR 20908 End */
...
typedef enum
{
    RRC_OAM_COMM_INFO_FAILURE,
    RRC_OAM_CELL_INDEX_MISMATCH
} rrc_comm_info_failure_cause_et;
...
/*NR_DC Code Change Start*/
    UECC_RRC_DC_PREP_TIMER,                /* 50 */
    UECC_RRC_DC_BEARER_CHANGE_GUARD_TIMER, /* 51 */
    UECC_RRC_ENDC_SGNB_REL_TIMER, /* 52 */
    UECC_RRC_ERAB_RELEASE_ENDC_GUARD_TIMER, /* 53 */
...
typedef struct _rrc_oam_sector_comm_info_t
{
    U8                           cell_index;                       
...
} rrc_oam_sector_comm_info_t;

typedef struct _rrc_oam_sector_comm_info_list_t
{
    U8                           count;                       
/*^ M, 0, B, 1, MAX_NUM_CELLS ^*/  /* MAX_NUM_CELLS */

    rrc_oam_sector_comm_info_t   sector_comm_info[MAX_NUM_CELLS];  
/*^ M, 0, OCTET_STRING, VARIABLE ^*/

} rrc_oam_sector_comm_info_list_t;

typedef struct _rrc_oam_communication_info_req_t
{
    rrc_oam_ext_comm_info_t ext_comm_info_upper_layer[RRC_OAM_MAX_EXT_UPPER_LAYER_MODULES];
/*^ M, 0, OCTET_STRING, FIXED ^*/
/* SPR 20908 Start */ 
  //  rrc_oam_sector_comm_info_list_t   sector_comm_info_list;  
  /*  M, 0, N, 0, 0  */
/* SPR 20908 End */
...
typedef struct _rrc_oam_sector_conn_status_t
{
    U8                           cell_index;                       
/*^ M, 0, H, 0, MAX_CELL_INDEX ^*/  /* MAX_NUM_CELLS-1 */

    rrc_oam_ext_connection_status_t ext_connection_status_lower_layer[RRC_OAM_MAX_EXT_LOWER_LAYER_MODULES];
/*^ M, 0, OCTET_STRING, FIXED ^*/

} rrc_oam_sector_conn_status_t;

typedef struct _rrc_oam_sector_conn_status_list_t
{
    U8                           count;                       
/*^ M, 0, B, 1, MAX_NUM_CELLS ^*/  /* MAX_NUM_CELLS */

    rrc_oam_sector_conn_status_t   sector_conn_status[MAX_NUM_CELLS];  
/*^ M, 0, OCTET_STRING, VARIABLE ^*/

} rrc_oam_sector_conn_status_list_t;

#define RRC_OAM_COMM_INFO_FAIL_CAUSE_PRESENT         0x01
...
/*^ M, 0, H, 0, 1 ^*/ /* rrc_return_et */
    ...
    U8                      cause;  
/*^ O, RRC_OAM_COMM_INFO_FAIL_CAUSE_PRESENT, H, 0, 1 ^*/ /*rrc_comm_info_failure_cause_et*/

    rrc_oam_ext_connection_status_t ext_connection_status_upper_layer[RRC_OAM_MAX_EXT_UPPER_LAYER_MODULES];
/*^ M, 0, OCTET_STRING, FIXED ^*/
/* SPR 20908 Start */
   // rrc_oam_sector_conn_status_list_t   sector_conn_status_list;  
/* M, 0, N, 0, 0 */
/* SPR 20908 End */
...
/* eMTC changes start */
#define RRC_OAM_MAX_NUM_SUPPORTED_EMTC_UE_PRESENT    0x01
/* eMTC changes stop */
typedef struct _rrc_oam_sector_info_t
{
    /* eMTC changes start */
...
/*^ M, 0, N, 0, 0 ^*/
    ...
    U16                         maxNumSupportedEmtcUe;
    /*^ O, RRC_OAM_MAX_NUM_SUPPORTED_EMTC_UE_PRESENT, B, 1, MAX_NUM_SUPPORTED_EMTC_UE ^*/
    /* eMTC changes stop */

} rrc_oam_sector_info_t;

typedef struct _rrc_oam_sector_info_list_t
{
    U8                      count;
/*^ M, 0, B, 1, MAX_NUM_CELLS  ^*/  

    rrc_oam_sector_info_t    sector_info[MAX_NUM_CELLS];
/*^ M, 0, OCTET_STRING, VARIABLE ^*/

} rrc_oam_sector_info_list_t;
...
/*^ M, 0, N, 0, 0 ^*/
    ...
    rrc_oam_sector_info_list_t   sector_info_list;
/*^ M, 0, N, 0, 0 ^*/
...
typedef struct _oam_rrc_ps_stats_resp_t
{
    U16           noOfUe;
/*^ M, 0, N, 0, 0 ^*/ 
    ueRrcInfoStatus_t  ueInfoStatus[PS_MAX_NUM_UE];
/*^ M, 0, OCTET_STRING, VARIABLE ^*/
...
typedef struct 
{
    rrc_inter_rat_type_et     rat_type;
    plmn_identity_t     plmn_identity;
    U8                  cell_identity[MAX_CELL_IDENTITY_NUMBYTES];
...
/* SPR-18445 start */
    U8  count;
    /*^ M, 0, H, 0, RRC_MAX_CONNECTION ^*/  /* BUG 12662 Fix Stop */
/* SPR-18445 stop */
    rrc_oam_meas_on_neigh_cell_ho_stats_t  
...
{
/*SPR_17664_start*/
    U8     length; /*^ M, 0, H, 0, MAX_TRANSPORT_LAYER_ADDR_SIZE  ^*/
...
typedef struct rrc_MsgPoolStatsT {
    /* This array is terminated when bufSize is 0 for an entry, other entries are not valid */
    rrc_PoolStats stats[NVARPOOL]; /*^ M, 0, OCTET_STRING, FIXED ^*/
    /* the QPCTL stats */
    rrc_PoolStats qpctlStats; /*^ M, 0, N, 0, 0 ^*/
    /* the QMSG stats */
    rrc_PoolStats qmsgStats; /*^ M, 0, N, 0, 0 ^*/
}rrc_MsgPoolStats;
