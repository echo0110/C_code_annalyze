...
/****************************************************************************/
{
    ...
    if( GL_FAILURE == gl_htm_create_hash_table( user_id,
                                                ...
                                                max_num_of_bucket, ( gw_U8bit )GL_HTM_USER_DEFINED_KEY_TYPE,
                                                ( gw_U8bit )GL_HTM_HASH_FUNC_FOR_STRING_KEYS, ( gl_htm_hash_fn_t )GL_NULL,
                                                ( gl_htm_free_key_elem_fn_t )sim_memory_free_func, ( gl_pvoid_t )GL_NULL,
                                                ( gl_htm_key_cmp_fn_t )GL_NULL, p_ecode ) )
    {
        g_a_p_sim_db[sim_db_id]->a_ln_array.a_ln_nodes = GL_NULL;
