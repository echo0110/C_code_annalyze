...
#define GL_MUTEX_LOCK(mutex_ptr, p_ecode, x)    gl_lock_mutex((mutex_ptr), (gw_U32bit)GL_NULL, p_ecode)
#define GL_MUTEX_UNLOCK(mutex_ptr, p_ecode, x)  gl_unlock_mutex((gl_thread_info_t *)GL_NULL, (mutex_ptr), p_ecode)
...
#define GL_MT_LOCK(mutex_ptr, p_ecode, x)    gl_lock_mutex((mutex_ptr), (gw_U32bit)GL_NULL, p_ecode)
#define GL_MT_UNLOCK(mutex_ptr, p_ecode, x)  gl_unlock_mutex((gl_thread_info_t *)GL_NULL, (mutex_ptr), p_ecode)
