...
sigtran_return_t   sigtran_htm_deinit( sigtran_error_t      *p_ecode )
{
    ...
    if( SIGTRAN_FALSE == sig_hash_init )
    {
        return ( sigtran_return_t )GL_SUCCESS;
    }
    ...
    {
        gl_mm_destroy_all_common_pools( GL_TRUE, &ecode );
    }
...
/***************************************************************************************
                        ...
                        GENLIB  WRAPPERS FOR STRING HASHING
...
/************************************************************************
** FUNCTION    :
**              sigtran_create_text_hash_table
**
** DESCRIPTION :
**              create a hash table
**  RETURN VALUE: SIGTRAN_SUCCESS/SIGTRAN_FAILURE
...
sigtran_return_t sigtran_create_text_hash_table( sigtran_S8bit         task_id,
                                                 sigtran_U16bit       *hash_table_id,
                                                 sigtran_U32bit        no_of_keys,
                                                 sigtran_U32bit        no_of_bucket,
                                                 sigtran_error_t       *p_ecode )
...
/************************************************************************
** FUNCTION    :
**             sigtran_delete_text_hash_table
**
** DESCRIPTION :
**              delete a hash table
**  RETURN VALUE: SIGTRAN_SUCCESS/SIGTRAN_FAILURE
*************************************************************************/
sigtran_return_t  sigtran_delete_text_hash_table( sigtran_S8bit   task_id,
                                                  sigtran_U16bit  hash_table_id,
                                                  sigtran_error_t *p_ecode )
{
    gw_error_t   error_code;
...
/************************************************************************
** FUNCTION    :
**              sigtran_insert_text_node
**
** DESCRIPTION :
**              Insert a key into the hash table
**  RETURN VALUE: SIGTRAN_SUCCESS/SIGTRAN_FAILURE
*************************************************************************/
sigtran_return_t  sigtran_insert_text_node( sigtran_S8bit   task_id,
                                            sigtran_U16bit  hash_table_id,
                                            sigtran_pvoid_t key,/*based on key_type*/
                                            sigtran_pvoid_t p_elem,
                                            sigtran_error_t *p_ecode )
...
/************************************************************************
** FUNCTION    :
**              sigtran_get_text_node
**
** DESCRIPTION :
**              Get a key from the hash table
**  RETURN VALUE: SIGTRAN_SUCCESS/SIGTRAN_FAILURE
*************************************************************************/
sigtran_return_t  sigtran_get_text_node( sigtran_S8bit    task_id,
                                         sigtran_U16bit   hash_table_id,
                                         sigtran_pvoid_t  key,
                                         sigtran_pvoid_t  *p_elem,
                                         sigtran_error_t  *p_ecode )
...
/************************************************************************
** FUNCTION    :
**              sigtran_delete_text_node
**
** DESCRIPTION :
**              Remove a key from the hash table
**  RETURN VALUE: SIGTRAN_SUCCESS/SIGTRAN_FAILURE
*************************************************************************/
sigtran_return_t  sigtran_delete_text_node( sigtran_S8bit   task_id,
                                            sigtran_U16bit  hash_table_id,
                                            sigtran_pvoid_t key,
                                            sigtran_pvoid_t *p_elem,
                                            sigtran_error_t *p_ecode )
