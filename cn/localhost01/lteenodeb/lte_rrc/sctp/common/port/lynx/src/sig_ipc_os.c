  ...
  unsigned char       b_is_iovec )
{
    ...
    entity_addr.sin6_addr.s6_addr32[0] = p_dest_ip[0];
    entity_addr.sin6_addr.s6_addr32[1] = p_dest_ip[1];
    entity_addr.sin6_addr.s6_addr32[2] = p_dest_ip[2];
    entity_addr.sin6_addr.s6_addr32[3] = p_dest_ip[3];
