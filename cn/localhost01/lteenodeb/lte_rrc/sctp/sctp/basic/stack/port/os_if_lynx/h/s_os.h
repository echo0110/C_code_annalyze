...
#define _SCTP_SS_ALIGNSIZE  (sizeof(u_int64_t))
...
#define _SCTP_SS_PAD2SIZE   (_SCTP_SS_MAXSIZE - SIZEOF_SA_FAMILY+ _SCTP_SS_PAD1SIZE \
    ...
    struct __sctp_sockaddr_storage
    {
        ...
        /*len field is added for lynx*/
        unsigned char len;            /*Length of the structure*/
        ...
        u_int64_t  __ss_align;     /* field to force desired structure */
...
#define SCTP_MAX_IP_ADDR_TYPE     2
    ...
    struct sctp_in6_addr
    {
        union
        {
            u_int8_t    _S6_u8[16];     /* IPv6 address */
            u_int32_t   _S6_u32[4];     /* IPv6 address */
            u_int32_t   __S6_align;     /* Align on 32 bit boundary */
        } _S6_un;
    };
    ...
    typedef struct __sctp_os_sockaddr_in6_st
    {
        ...
        u_int32_t        sin6_scope_id;  /* Depends on scope of sin6_addr */
        u_int32_t        __sin6_src_id;  /* Impl. specific - UDP replies */
