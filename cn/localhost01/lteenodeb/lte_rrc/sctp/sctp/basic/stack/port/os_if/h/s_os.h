...
#define _SCTP_SS_MAXSIZE    128
    ...
    typedef unsigned long long     sctp_U64bit;
#else
    typedef struct
    {
        unsigned int     high32;
...
#define _SCTP_SS_ALIGNSIZE  (sizeof(sctp_U64bit))
...
#define _SCTP_SS_PAD2SIZE   (_SCTP_SS_MAXSIZE - SIZEOF_SA_FAMILY+ _SCTP_SS_PAD1SIZE \
    ...
    struct __sctp_sockaddr_storage
    {
        ...
        sctp_U64bit  __ss_align;     /* field to force desired structure */
...
#define _SOCKLEN_T
    ...
    typedef struct __sctp_os_sockaddr_in6_st
    {
        ...
        struct sctp_in6_addr sin6_addr;
